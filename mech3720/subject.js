...
window.SUBJECT = {
  ...
  equations:[
    ...
    {id:"eq-specific-volume", cat:"Concepts, work & heat", name:"Specific volume & density",
     ...
     vars:[{sym:R`v`,mean:"specific volume (m³/kg)",href:"glossary.html#g-specific-volume"},
           {sym:R`V`,mean:"total volume (m³)",href:"glossary.html#g-volume"},
           ...
           {sym:R`F`,mean:"normal force (N)",href:"glossary.html#g-force"},
           {sym:R`A`,mean:"area (m²)",href:"glossary.html#g-area"}],
    ...
    {id:"eq-ke-pe", cat:"Concepts, work & heat", name:"Kinetic & potential energy change",
     ...
     vars:[{sym:R`\Delta KE`,mean:"change in kinetic energy (J)",href:"glossary.html#g-energy"},
           {sym:R`\Delta PE`,mean:"change in potential energy (J)",href:"glossary.html#g-energy"},
           {sym:R`m`,mean:"mass (kg)",href:"glossary.html#g-mass"},
           {sym:R`\mathrm{v}`,mean:"velocity (m/s) — roman v, not specific volume",href:"glossary.html#g-velocity"},
           {sym:R`z`,mean:"elevation (m)",href:"glossary.html#g-elevation"},
    ...
    {id:"eq-pdv-work", cat:"Concepts, work & heat", name:"Expansion / compression work",
     ...
     vars:[{sym:R`W`,mean:"boundary work (J), positive out of the system",href:"glossary.html#g-work"},
           {sym:R`F`,mean:"force on the boundary (N)",href:"glossary.html#g-force"},
           {sym:R`s`,mean:"displacement of the boundary (m)",href:"glossary.html#g-work"},
           {sym:R`p`,mean:"pressure (Pa)",href:"glossary.html#g-pressure"},
    ...
    {id:"eq-polytropic-work", cat:"Concepts, work & heat", name:"Polytropic process & its work",
     ...
     vars:[{sym:R`p`,mean:"pressure (Pa)",href:"glossary.html#g-pressure"},
           {sym:R`V`,mean:"volume (m³)",href:"glossary.html#g-volume"},
           {sym:R`n`,mean:"polytropic exponent",href:"glossary.html#g-polytropic-exponent"},
           {sym:R`p_1,p_2`,mean:"end pressures",href:"glossary.html#g-pressure"},
           {sym:R`V_1,V_2`,mean:"end volumes",href:"glossary.html#g-volume"}],
    ...
    {id:"eq-heat-modes", cat:"Concepts, work & heat", name:"Heat transfer rate laws",
     ...
     vars:[{sym:R`\dot Q`,mean:"heat transfer rate (W)",href:"glossary.html#g-rate"},
           {sym:R`A`,mean:"area normal to the flow of heat (m²)",href:"glossary.html#g-area"},
           {sym:R`k`,mean:"thermal conductivity (W/m·K)",href:"glossary.html#g-heat-transfer-coeffs"},
           {sym:R`T`,mean:"temperature (K)",href:"glossary.html#g-temperature"},
           {sym:R`x`,mean:"distance through the material (m)",href:"glossary.html#g-heat-transfer-coeffs"},
           {sym:R`h`,mean:"convection coefficient (W/m²·K)",href:"glossary.html#g-heat-transfer-coeffs"},
           {sym:R`T_b,T_f,T_s`,mean:"body, fluid and surroundings temperatures",href:"glossary.html#g-temperature"},
           {sym:R`e`,mean:"emissivity (0–1)",href:"glossary.html#g-heat-transfer-coeffs"},
           {sym:R`\sigma`,mean:"Stefan-Boltzmann constant, 5.67×10⁻⁸ W/m²·K⁴",href:"glossary.html#g-heat-transfer-coeffs"}],
    ...
    {id:"eq-total-energy", cat:"First law — closed systems", name:"Total energy of a system",
     ...
     vars:[{sym:R`E,\,\Delta E`,mean:"total stored energy and its change (J)",href:"glossary.html#g-energy"},
           {sym:R`U,\,\Delta U`,mean:"internal energy and its change (J)",href:"glossary.html#g-internal-energy"},
           {sym:R`KE,PE`,mean:"kinetic and potential energy (J)",href:"glossary.html#g-energy"},
           {sym:R`\Delta`,mean:"denotes a change between two states",href:"glossary.html#g-property"}],
    ...
    {id:"eq-energy-closed", cat:"First law — closed systems", name:"Energy balance (closed system)",
     ...
     vars:[{sym:R`\Delta U`,mean:"change in internal energy (J)",href:"glossary.html#g-internal-energy"},
           {sym:R`\Delta KE,\Delta PE`,mean:"changes in kinetic and potential energy (J)",href:"glossary.html#g-energy"},
           {sym:R`Q`,mean:"net heat transfer IN (J)",href:"glossary.html#g-heat"},
           {sym:R`W`,mean:"net work OUT (J)",href:"glossary.html#g-work"}],
    ...
    {id:"eq-energy-rate", cat:"First law — closed systems", name:"Rate form of the energy balance",
     ...
     vars:[{sym:R`E`,mean:"total stored energy (J)",href:"glossary.html#g-energy"},
           {sym:R`t`,mean:"time (s)",href:"glossary.html#g-time"},
           {sym:R`\dot Q`,mean:"heat transfer rate in (W)",href:"glossary.html#g-rate"},
           {sym:R`\dot W`,mean:"power out (W)",href:"glossary.html#g-rate"}],
     links:[{label:"Topic 1",href:"week-01.html"}],
    ...
    {id:"eq-cycle", cat:"First law — closed systems", name:"Energy balance for a cycle",
     ...
     vars:[{sym:R`Q_{cycle}`,mean:"net heat transfer over the cycle (J)",href:"glossary.html#g-heat"},
           {sym:R`W_{cycle}`,mean:"net work over the cycle (J)",href:"glossary.html#g-work"}],
    ...
    {id:"eq-thermal-efficiency", cat:"First law — closed systems", name:"Thermal efficiency",
     ...
     vars:[{sym:R`\eta`,mean:"thermal efficiency",href:"glossary.html#g-thermal-efficiency"},
           {sym:R`W_{cycle}`,mean:"net work over the cycle (J)",href:"glossary.html#g-work"},
           {sym:R`Q_{in}`,mean:"heat added from the hot reservoir (J)",href:"glossary.html#g-heat"},
           {sym:R`Q_{out}`,mean:"heat rejected to the cold reservoir (J)",href:"glossary.html#g-heat"}],
    ...
    {id:"eq-cop-ref", cat:"First law — closed systems", name:"Coefficient of performance (refrigeration)",
     ...
     vars:[{sym:R`\beta`,mean:"coefficient of performance, refrigeration",href:"glossary.html#g-cop"},
           {sym:R`Q_C`,mean:"heat removed from the cold body (J)",href:"glossary.html#g-heat"},
           {sym:R`Q_H`,mean:"heat rejected to the hot body (J)",href:"glossary.html#g-heat"},
           {sym:R`W_{cycle}`,mean:"work input over the cycle (J)",href:"glossary.html#g-work"}],
    ...
    {id:"eq-cop-hp", cat:"First law — closed systems", name:"Coefficient of performance (heat pump)",
     ...
     vars:[{sym:R`\gamma`,mean:"coefficient of performance, heat pump",href:"glossary.html#g-cop"},
           {sym:R`\beta`,mean:"coefficient of performance, refrigeration",href:"glossary.html#g-cop"},
           {sym:R`Q_H`,mean:"heat delivered to the hot body (J)",href:"glossary.html#g-heat"},
           {sym:R`Q_C`,mean:"heat drawn from the cold body (J)",href:"glossary.html#g-heat"},
           {sym:R`W_{cycle}`,mean:"work input over the cycle (J)",href:"glossary.html#g-work"}],
     links:[{label:"Topic 1",href:"week-01.html"},{label:"Topic 8",href:"week-08.html"},{label:"COP",href:"glossary.html#g-cop"}],
    ...
    {id:"eq-quality-props", cat:"Properties of substances", name:"Quality & mixture properties",
     ...
     vars:[{sym:R`x`,mean:"quality — the vapour mass fraction (0–1)",href:"glossary.html#g-quality"},
           {sym:R`m_{vap},m_{liq}`,mean:"vapour and liquid masses (kg)",href:"glossary.html#g-mass"},
           {sym:R`v`,mean:"specific volume of the mixture (m³/kg)",href:"glossary.html#g-specific-volume"},
           {sym:R`v_f`,mean:"saturated-liquid specific volume",href:"glossary.html#g-specific-volume"},
           {sym:R`v_g`,mean:"saturated-vapour specific volume",href:"glossary.html#g-specific-volume"}],
    ...
    {id:"eq-enthalpy", cat:"Properties of substances", name:"Enthalpy",
     ...
     vars:[{sym:R`H`,mean:"enthalpy (J)",href:"glossary.html#g-enthalpy"},
           {sym:R`h`,mean:"specific enthalpy (J/kg)",href:"glossary.html#g-enthalpy"},
           {sym:R`U,u`,mean:"internal energy, total and specific",href:"glossary.html#g-internal-energy"},
           {sym:R`p`,mean:"pressure (Pa)",href:"glossary.html#g-pressure"},
           {sym:R`V,v`,mean:"volume and specific volume",href:"glossary.html#g-volume"}],
    ...
    {id:"eq-specific-heats", cat:"Properties of substances", name:"Specific heats",
     ...
     vars:[{sym:R`c_p`,mean:"specific heat at constant pressure (J/kg·K)",href:"glossary.html#g-specific-heat"},
           {sym:R`c_v`,mean:"specific heat at constant volume (J/kg·K)",href:"glossary.html#g-specific-heat"},
           {sym:R`h`,mean:"specific enthalpy (J/kg)",href:"glossary.html#g-enthalpy"},
           {sym:R`u`,mean:"specific internal energy (J/kg)",href:"glossary.html#g-internal-energy"},
           {sym:R`T`,mean:"temperature (K)",href:"glossary.html#g-temperature"},
           {sym:R`k`,mean:"specific-heat ratio",href:"glossary.html#g-specific-heat-ratio"}],
    ...
    {id:"eq-incompressible", cat:"Properties of substances", name:"Incompressible-substance model",
     ...
     vars:[{sym:R`c`,mean:"the single specific heat of an incompressible substance",href:"glossary.html#g-specific-heat"},
           {sym:R`c_p,c_v`,mean:"specific heats — equal for an incompressible substance",href:"glossary.html#g-specific-heat"},
           {sym:R`u_1,u_2`,mean:"specific internal energy (J/kg)",href:"glossary.html#g-internal-energy"},
           {sym:R`h_1,h_2`,mean:"specific enthalpy (J/kg)",href:"glossary.html#g-enthalpy"},
           {sym:R`T_1,T_2`,mean:"end temperatures (K)",href:"glossary.html#g-temperature"},
           {sym:R`v`,mean:"specific volume, taken constant (m³/kg)",href:"glossary.html#g-specific-volume"},
           {sym:R`p_1,p_2`,mean:"end pressures (Pa)",href:"glossary.html#g-pressure"}],
    ...
    {id:"eq-ideal-gas", cat:"Properties of substances", name:"Ideal-gas equation of state",
     ...
     vars:[{sym:R`p`,mean:"absolute pressure (Pa)",href:"glossary.html#g-pressure"},
           {sym:R`V`,mean:"volume (m³)",href:"glossary.html#g-volume"},
           {sym:R`v`,mean:"specific volume (m³/kg)",href:"glossary.html#g-specific-volume"},
           {sym:R`m`,mean:"mass (kg)",href:"glossary.html#g-mass"},
    ...
    {id:"eq-gas-constant", cat:"Properties of substances", name:"Gas constant",
     ...
     vars:[{sym:R`R`,mean:"specific gas constant (J/kg·K)",href:"glossary.html#g-gas-constant"},
           {sym:R`\bar R`,mean:"universal gas constant, 8.314 kJ/kmol·K",href:"glossary.html#g-gas-constant"},
           {sym:R`M`,mean:"molar mass (kg/kmol)",href:"glossary.html#g-molar-mass"},
           {sym:R`M_{air}`,mean:"molar mass of air, 28.97 kg/kmol",href:"glossary.html#g-molar-mass"}],
    ...
    {id:"eq-ideal-gas-uh", cat:"Properties of substances", name:"Ideal-gas Δu, Δh and Mayer's relation",
     ...
     vars:[{sym:R`u_1,u_2`,mean:"specific internal energy (J/kg)",href:"glossary.html#g-internal-energy"},
           {sym:R`h_1,h_2`,mean:"specific enthalpy (J/kg)",href:"glossary.html#g-enthalpy"},
           {sym:R`c_v,c_p`,mean:"specific heats (J/kg·K)",href:"glossary.html#g-specific-heat"},
           {sym:R`T_1,T_2`,mean:"end temperatures (K)",href:"glossary.html#g-temperature"},
           {sym:R`R`,mean:"specific gas constant (J/kg·K)",href:"glossary.html#g-gas-constant"}],
     links:[{label:"Topic 2",href:"week-02.html"},{label:"Ideal gas",href:"glossary.html#g-ideal-gas"}],
    ...
    {id:"eq-polytropic-ideal", cat:"Properties of substances", name:"Ideal-gas polytropic relations",
     ...
     vars:[{sym:R`T_1,T_2`,mean:"end temperatures (K)",href:"glossary.html#g-temperature"},
           {sym:R`p_1,p_2`,mean:"end pressures (Pa)",href:"glossary.html#g-pressure"},
           {sym:R`V_1,V_2`,mean:"end volumes (m³)",href:"glossary.html#g-volume"},
           {sym:R`n`,mean:"polytropic exponent",href:"glossary.html#g-polytropic-exponent"},
           {sym:R`p`,mean:"pressure (Pa)",href:"glossary.html#g-pressure"},
           {sym:R`V`,mean:"volume (m³)",href:"glossary.html#g-volume"},
           {sym:R`m`,mean:"mass (kg)",href:"glossary.html#g-mass"},
    ...
    {id:"eq-mass-conservation", cat:"Mass & energy in control volumes", name:"Conservation of mass",
     ...
     vars:[{sym:R`m_{cv}`,mean:"mass inside the control volume (kg)",href:"glossary.html#g-mass"},
           {sym:R`t`,mean:"time (s)",href:"glossary.html#g-time"},
           {sym:R`\dot m_i,\dot m_e`,mean:"inlet and exit mass-flow rates (kg/s)",href:"glossary.html#g-mass-flow"}],
    ...
    {id:"eq-mass-flow", cat:"Mass & energy in control volumes", name:"1-D mass-flow rate",
     ...
     vars:[{sym:R`\dot m`,mean:"mass-flow rate (kg/s)",href:"glossary.html#g-mass-flow"},
           ...
           {sym:R`\mathrm{v}`,mean:"velocity (m/s) — roman v",href:"glossary.html#g-velocity"},
           {sym:R`v`,mean:"specific volume (m³/kg) — italic v",href:"glossary.html#g-specific-volume"}],
    ...
    {id:"eq-energy-cv", cat:"Mass & energy in control volumes", name:"Energy rate balance (control volume)",
     ...
     vars:[{sym:R`E_{cv}`,mean:"energy stored in the control volume (J)",href:"glossary.html#g-energy"},
           {sym:R`t`,mean:"time (s)",href:"glossary.html#g-time"},
           {sym:R`\dot Q_{cv}`,mean:"heat transfer rate in (W)",href:"glossary.html#g-rate"},
           {sym:R`\dot W_{cv}`,mean:"shaft / other power out (W)",href:"glossary.html#g-rate"},
           {sym:R`\dot m_i,\dot m_e`,mean:"inlet and exit mass-flow rates (kg/s)",href:"glossary.html#g-mass-flow"},
           {sym:R`h`,mean:"specific enthalpy carried by the stream (J/kg)",href:"glossary.html#g-enthalpy"},
           {sym:R`\mathrm{v}`,mean:"stream velocity (m/s)",href:"glossary.html#g-velocity"},
           {sym:R`g`,mean:"gravitational acceleration (9.81 m/s²)",href:"glossary.html#g-gravity"},
           {sym:R`z`,mean:"elevation (m)",href:"glossary.html#g-elevation"}],
    ...
    {id:"eq-sfee", cat:"Mass & energy in control volumes", name:"Steady-flow energy equation (one inlet/exit)",
     ...
     vars:[{sym:R`\dot Q_{cv}`,mean:"heat transfer rate in (W)",href:"glossary.html#g-rate"},
           {sym:R`\dot W_{cv}`,mean:"shaft power out (W)",href:"glossary.html#g-rate"},
           {sym:R`\dot m`,mean:"mass-flow rate (kg/s)",href:"glossary.html#g-mass-flow"},
           {sym:R`h_i,h_e`,mean:"inlet and exit specific enthalpy (J/kg)",href:"glossary.html#g-enthalpy"},
           {sym:R`\mathrm{v}_i,\mathrm{v}_e`,mean:"inlet and exit velocity (m/s)",href:"glossary.html#g-velocity"},
           {sym:R`g`,mean:"gravitational acceleration (9.81 m/s²)",href:"glossary.html#g-gravity"},
           {sym:R`z_i,z_e`,mean:"inlet and exit elevation (m)",href:"glossary.html#g-elevation"}],
     links:[{label:"Topic 3",href:"week-03.html"}],
    ...
    {id:"eq-transient-cv", cat:"Mass & energy in control volumes", name:"Transient control-volume balances",
     ...
     vars:[{sym:R`m_{cv}`,mean:"mass in the control volume (kg)",href:"glossary.html#g-mass"},
           {sym:R`U_{cv}`,mean:"internal energy in the control volume (J)",href:"glossary.html#g-internal-energy"},
           {sym:R`t`,mean:"time (s)",href:"glossary.html#g-time"},
           {sym:R`m_i,m_e`,mean:"total mass in and out over the process (kg)",href:"glossary.html#g-mass"},
           {sym:R`Q_{cv},W_{cv}`,mean:"total heat in and work out over the process (J)",href:"glossary.html#g-heat"},
           {sym:R`h_i,h_e`,mean:"inlet and exit specific enthalpy (J/kg)",href:"glossary.html#g-enthalpy"}],
     links:[{label:"Topic 3",href:"week-03.html"}],
    ...
    {id:"eq-kelvin-planck", cat:"Second law", name:"Kelvin–Planck statement (analytical)",
     ...
     vars:[{sym:R`W_{cycle}`,mean:"net work over the cycle (J)",href:"glossary.html#g-work"}],
    ...
    {id:"eq-carnot-efficiency", cat:"Second law", name:"Carnot (maximum) thermal efficiency",
     ...
     vars:[{sym:R`\eta_{max}`,mean:"maximum (Carnot) thermal efficiency",href:"glossary.html#g-thermal-efficiency"},
           {sym:R`T_H`,mean:"hot-reservoir temperature (K)",href:"glossary.html#g-temperature"},
           {sym:R`T_C`,mean:"cold-reservoir temperature (K)",href:"glossary.html#g-temperature"}],
    ...
    {id:"eq-carnot-cop-ref", cat:"Second law", name:"Maximum COP — refrigeration",
     ...
     vars:[{sym:R`\beta_{max}`,mean:"maximum refrigeration COP",href:"glossary.html#g-cop"},
           {sym:R`T_C`,mean:"cold-space temperature (K)",href:"glossary.html#g-temperature"},
           {sym:R`T_H`,mean:"warm-surroundings temperature (K)",href:"glossary.html#g-temperature"}],
    ...
    {id:"eq-carnot-cop-hp", cat:"Second law", name:"Maximum COP — heat pump",
     ...
     vars:[{sym:R`\gamma_{max}`,mean:"maximum heat-pump COP",href:"glossary.html#g-cop"},
           {sym:R`T_H`,mean:"delivered-heat temperature (K)",href:"glossary.html#g-temperature"},
           {sym:R`T_C`,mean:"source temperature (K)",href:"glossary.html#g-temperature"}],
     links:[{label:"Topic 4",href:"week-04.html"},{label:"Topic 8",href:"week-08.html"}],
    ...
    {id:"eq-clausius", cat:"Entropy", name:"Clausius inequality",
     ...
     vars:[{sym:R`\delta Q`,mean:"differential heat transfer (J)",href:"glossary.html#g-heat"},
           {sym:R`T`,mean:"boundary temperature (K)",href:"glossary.html#g-temperature"},
           {sym:R`b`,mean:"evaluated at the boundary",href:"glossary.html#g-temperature"},
           {sym:R`\sigma_{cycle}`,mean:"entropy produced over the cycle (J/K)",href:"glossary.html#g-entropy-production"}],
    ...
    {id:"eq-entropy-def", cat:"Entropy", name:"Definition of entropy",
     ...
     vars:[{sym:R`S`,mean:"entropy (J/K)",href:"glossary.html#g-entropy"},
           {sym:R`\delta Q`,mean:"differential heat transfer (J)",href:"glossary.html#g-heat"},
           {sym:R`T`,mean:"absolute temperature (K)",href:"glossary.html#g-temperature"},
           {sym:R`int,rev`,mean:"along an internally reversible path",href:"glossary.html#g-reversible"},
           {sym:R`s`,mean:"specific entropy of the mixture (J/kg·K)",href:"glossary.html#g-entropy"},
           {sym:R`s_f,s_g`,mean:"saturated-liquid and saturated-vapour entropy",href:"glossary.html#g-entropy"},
           {sym:R`x`,mean:"quality",href:"glossary.html#g-quality"}],
     links:[{label:"Topic 5",href:"week-05.html"},{label:"Entropy",href:"glossary.html#g-entropy"}],
    ...
    {id:"eq-tds", cat:"Entropy", name:"The TdS equations",
     ...
     vars:[{sym:R`T`,mean:"absolute temperature (K)",href:"glossary.html#g-temperature"},
           {sym:R`S`,mean:"entropy (J/K)",href:"glossary.html#g-entropy"},
           {sym:R`U`,mean:"internal energy (J)",href:"glossary.html#g-internal-energy"},
           {sym:R`H`,mean:"enthalpy (J)",href:"glossary.html#g-enthalpy"},
           {sym:R`p`,mean:"pressure (Pa)",href:"glossary.html#g-pressure"},
           {sym:R`V`,mean:"volume (m³)",href:"glossary.html#g-volume"}],
    ...
    {id:"eq-entropy-incompressible", cat:"Entropy", name:"Entropy change — incompressible substance",
     ...
     vars:[{sym:R`s_1,s_2`,mean:"specific entropy (J/kg·K)",href:"glossary.html#g-entropy"},
           {sym:R`c`,mean:"specific heat of the incompressible substance",href:"glossary.html#g-specific-heat"},
           {sym:R`T_1,T_2`,mean:"end temperatures (K)",href:"glossary.html#g-temperature"}],
     links:[{label:"Topic 5",href:"week-05.html"}],
    ...
    {id:"eq-entropy-ideal", cat:"Entropy", name:"Entropy change — ideal gas (constant cp, cv)",
     ...
     vars:[{sym:R`s_1,s_2`,mean:"specific entropy (J/kg·K)",href:"glossary.html#g-entropy"},
           ...
           {sym:R`T_1,T_2`,mean:"end temperatures (K)",href:"glossary.html#g-temperature"},
           {sym:R`R`,mean:"specific gas constant (J/kg·K)",href:"glossary.html#g-gas-constant"},
           {sym:R`v_1,v_2`,mean:"end specific volumes (m³/kg)",href:"glossary.html#g-specific-volume"},
           {sym:R`p_1,p_2`,mean:"end pressures (Pa)",href:"glossary.html#g-pressure"}],
    ...
    {id:"eq-entropy-tables", cat:"Entropy", name:"Entropy of an ideal gas using s° tables",
     ...
     vars:[{sym:R`s`,mean:"specific entropy (J/kg·K)",href:"glossary.html#g-entropy"},
           {sym:R`s^{\circ}(T)`,mean:"tabulated temperature-dependent entropy",href:"glossary.html#g-entropy"},
           {sym:R`T_1,T_2`,mean:"end temperatures (K)",href:"glossary.html#g-temperature"},
           {sym:R`p_1,p_2`,mean:"end pressures (Pa)",href:"glossary.html#g-pressure"},
           {sym:R`R`,mean:"specific gas constant (J/kg·K)",href:"glossary.html#g-gas-constant"}],
     links:[{label:"Topic 5",href:"week-05.html"}],
    ...
    {id:"eq-entropy-closed", cat:"Entropy", name:"Entropy balance (closed system)",
     ...
     vars:[{sym:R`S_1,S_2`,mean:"entropy at the start and end (J/K)",href:"glossary.html#g-entropy"},
           {sym:R`\delta Q`,mean:"differential heat transfer (J)",href:"glossary.html#g-heat"},
           {sym:R`T`,mean:"boundary temperature (K)",href:"glossary.html#g-temperature"},
           {sym:R`b`,mean:"evaluated at the boundary",href:"glossary.html#g-temperature"},
           {sym:R`\sigma`,mean:"entropy produced (≥ 0)",href:"glossary.html#g-entropy-production"}],
    ...
    {id:"eq-entropy-cv", cat:"Entropy", name:"Entropy rate balance (control volume)",
     ...
     vars:[{sym:R`S_{cv}`,mean:"entropy in the control volume (J/K)",href:"glossary.html#g-entropy"},
           {sym:R`t`,mean:"time (s)",href:"glossary.html#g-time"},
           {sym:R`\dot Q_j`,mean:"heat transfer rate at boundary j (W)",href:"glossary.html#g-rate"},
           {sym:R`T_j`,mean:"temperature at boundary j (K)",href:"glossary.html#g-temperature"},
           {sym:R`\dot m_i,\dot m_e`,mean:"inlet and exit mass-flow rates (kg/s)",href:"glossary.html#g-mass-flow"},
           {sym:R`s_i,s_e`,mean:"specific entropy of the streams (J/kg·K)",href:"glossary.html#g-entropy"},
           {sym:R`\dot\sigma_{cv}`,mean:"entropy production rate (W/K)",href:"glossary.html#g-entropy-production"}],
     links:[{label:"Topic 5",href:"week-05.html"}],
    ...
    {id:"eq-turbine-eff", cat:"Entropy", name:"Isentropic turbine & nozzle efficiency",
     ...
     vars:[{sym:R`\eta_t`,mean:"isentropic turbine efficiency",href:"glossary.html#g-isentropic-efficiency"},
           {sym:R`\eta_{nozzle}`,mean:"isentropic nozzle efficiency",href:"glossary.html#g-isentropic-efficiency"},
           {sym:R`\dot W_{cv}`,mean:"shaft power out (W)",href:"glossary.html#g-rate"},
           {sym:R`\dot m`,mean:"mass-flow rate (kg/s)",href:"glossary.html#g-mass-flow"},
           {sym:R`h_1`,mean:"inlet specific enthalpy (J/kg)",href:"glossary.html#g-enthalpy"},
           {sym:R`h_2`,mean:"actual exit specific enthalpy (J/kg)",href:"glossary.html#g-enthalpy"},
           {sym:R`h_{2s}`,mean:"isentropic exit specific enthalpy (J/kg)",href:"glossary.html#g-enthalpy"},
           {sym:R`\mathrm{v}_2`,mean:"actual exit velocity (m/s)",href:"glossary.html#g-velocity"},
           {sym:R`s`,mean:"subscript s denotes the isentropic case",href:"glossary.html#g-isentropic"}],
    ...
    {id:"eq-compressor-eff", cat:"Entropy", name:"Isentropic compressor & pump efficiency",
     ...
     vars:[{sym:R`\eta_c`,mean:"isentropic compressor / pump efficiency",href:"glossary.html#g-isentropic-efficiency"},
           {sym:R`\dot W_{cv}`,mean:"power input (W)",href:"glossary.html#g-rate"},
           {sym:R`\dot m`,mean:"mass-flow rate (kg/s)",href:"glossary.html#g-mass-flow"},
           {sym:R`h_1`,mean:"inlet specific enthalpy (J/kg)",href:"glossary.html#g-enthalpy"},
           {sym:R`h_2`,mean:"actual exit specific enthalpy (J/kg)",href:"glossary.html#g-enthalpy"},
           {sym:R`h_{2s}`,mean:"isentropic exit specific enthalpy (J/kg)",href:"glossary.html#g-enthalpy"},
    ...
    {id:"eq-pump-work", cat:"Vapour power (Rankine)", name:"Pump work for an incompressible liquid",
     ...
     vars:[{sym:R`\dot W_{pump}`,mean:"pump power input (W)",href:"glossary.html#g-rate"},
           {sym:R`\dot m`,mean:"mass-flow rate (kg/s)",href:"glossary.html#g-mass-flow"},
           {sym:R`h_3,h_4`,mean:"pump inlet and exit specific enthalpy (J/kg)",href:"glossary.html#g-enthalpy"},
           {sym:R`v_3`,mean:"saturated-liquid specific volume at pump inlet",href:"glossary.html#g-specific-volume"},
           {sym:R`p_3,p_4`,mean:"condenser and boiler pressure (Pa)",href:"glossary.html#g-pressure"}],
    ...
    {id:"eq-bwr", cat:"Vapour power (Rankine)", name:"Back-work ratio",
     ...
     vars:[{sym:R`bwr`,mean:"back-work ratio",href:"glossary.html#g-bwr"},
           {sym:R`\dot W_{pump}`,mean:"pump power input (W)",href:"glossary.html#g-rate"},
           {sym:R`\dot W_{turbine}`,mean:"turbine power output (W)",href:"glossary.html#g-rate"},
           {sym:R`\dot m`,mean:"mass-flow rate (kg/s)",href:"glossary.html#g-mass-flow"},
           {sym:R`h_1,h_2`,mean:"turbine inlet and exit specific enthalpy",href:"glossary.html#g-enthalpy"},
           {sym:R`h_3,h_4`,mean:"pump inlet and exit specific enthalpy",href:"glossary.html#g-enthalpy"}],
    ...
    {id:"eq-compression-ratio", cat:"Gas power cycles", name:"Compression ratio & displacement",
     ...
     vars:[{sym:R`r`,mean:"compression ratio",href:"glossary.html#g-compression-ratio"},
           {sym:R`V_{BDC}`,mean:"cylinder volume at bottom dead centre (m³)",href:"glossary.html#g-volume"},
           {sym:R`V_{TDC}`,mean:"clearance volume at top dead centre (m³)",href:"glossary.html#g-volume"},
           {sym:R`V_{disp}`,mean:"displacement (swept) volume (m³)",href:"glossary.html#g-volume"}],
    ...
    {id:"eq-mep", cat:"Gas power cycles", name:"Mean effective pressure",
     ...
     vars:[{sym:R`mep`,mean:"mean effective pressure (Pa)",href:"glossary.html#g-mep"},
           {sym:R`W_{net}`,mean:"net cycle work (J)",href:"glossary.html#g-work"},
           {sym:R`V_{max},V_{min}`,mean:"largest and smallest cylinder volumes (m³)",href:"glossary.html#g-volume"}],
    ...
    {id:"eq-otto", cat:"Gas power cycles", name:"Otto-cycle thermal efficiency (cold air-standard)",
     ...
     vars:[{sym:R`\eta_{Otto}`,mean:"cold-air-standard Otto thermal efficiency",href:"glossary.html#g-otto"},
           {sym:R`r`,mean:"compression ratio",href:"glossary.html#g-compression-ratio"},
    ...
    {id:"eq-diesel", cat:"Gas power cycles", name:"Diesel-cycle thermal efficiency (cold air-standard)",
     ...
     vars:[{sym:R`\eta_{Diesel}`,mean:"cold-air-standard Diesel thermal efficiency",href:"glossary.html#g-diesel"},
           {sym:R`r`,mean:"compression ratio",href:"glossary.html#g-compression-ratio"},
           {sym:R`r_c`,mean:"cut-off ratio, V₃/V₂",href:"glossary.html#g-diesel"},
           {sym:R`k`,mean:"specific-heat ratio (1.4 for air)",href:"glossary.html#g-specific-heat-ratio"}],
    ...
    {id:"eq-constants", cat:"Reference values", name:"Handy constants",
     ...
     vars:[{sym:R`\bar R`,mean:"universal gas constant, 8.314 kJ/kmol·K",href:"glossary.html#g-gas-constant"},
           {sym:R`R_{air}`,mean:"gas constant of air, 0.287 kJ/kg·K",href:"glossary.html#g-gas-constant"},
           {sym:R`k_{air}`,mean:"specific-heat ratio of air, 1.4",href:"glossary.html#g-specific-heat-ratio"},
           {sym:R`T`,mean:"temperature — convert °C to K before using any of these",href:"glossary.html#g-temperature"}],
     links:[{label:"Topic 2",href:"week-02.html"}],
  ...
  glossary:[
    ...
    /* ---------------------------------------------------------------
       ...
       Watch the collisions this subject genuinely has: v is both
       velocity and specific volume, sigma is both entropy production
       and the Stefan-Boltzmann constant, and k is both the specific-
       heat ratio and thermal conductivity.
       --------------------------------------------------------------- */
    {id:"g-pressure", term:"Pressure", sym:R`p`,
      def:R`Normal force per unit area (Pa), \(p = F/A\). 1 Pa = 1 N/m², 1 bar = 10⁵ Pa. Absolute pressure is required in the ideal-gas law — not gauge.`,
      see:[{label:"Ideal-gas equation",href:"equations.html#eq-ideal-gas"}]},
    {id:"g-temperature", term:"Temperature", sym:R`T`,
      def:R`Always absolute (K) in this course. Every efficiency, COP and ideal-gas relation breaks if you use °C — convert with \(T[\text{K}] = T[^{\circ}\text{C}] + 273.15\).`,
      see:[{label:"Handy constants",href:"equations.html#eq-constants"}]},
    {id:"g-volume", term:"Volume", sym:R`V`,
      def:R`Total volume occupied (m³). An extensive property — divide by mass to get the intensive specific volume \(v\).`,
      see:[{label:"Specific volume",href:"glossary.html#g-specific-volume"}]},
    {id:"g-specific-volume", term:"Specific volume", sym:R`v`,
      def:R`Volume per unit mass (m³/kg), the reciprocal of density. <strong>Beware:</strong> the formula sheet uses roman \(\mathrm{v}\) for velocity and italic \(v\) for specific volume — they appear in the same equations.`,
      see:[{label:"Specific volume & density",href:"equations.html#eq-specific-volume"}]},
    {id:"g-density", term:"Density", sym:R`\rho`,
      def:R`Mass per unit volume (kg/m³), the reciprocal of specific volume.`,
      see:[{label:"Specific volume & density",href:"equations.html#eq-specific-volume"}]},
    {id:"g-mass", term:"Mass", sym:R`m`,
      def:R`The amount of substance in the system (kg). Fixed for a closed system — that is what makes it closed.`,
      see:[{label:"System",href:"glossary.html#g-system"}]},
    {id:"g-mass-flow", term:"Mass flow rate", sym:R`\dot m`,
      def:R`Mass crossing a control surface per unit time (kg/s), \(\dot m = \rho A\mathrm{v}\). Equal at inlet and exit for steady flow.`,
      see:[{label:"1-D mass-flow rate",href:"equations.html#eq-mass-flow"}]},
    {id:"g-velocity", term:"Velocity", sym:R`\mathrm{v}`,
      def:R`Speed of the flow (m/s), written roman to distinguish it from specific volume. Carries the kinetic-energy term \(\mathrm{v}^2/2\) in the control-volume energy balance.`,
      see:[{label:"Specific volume",href:"glossary.html#g-specific-volume"}]},
    {id:"g-elevation", term:"Elevation", sym:R`z`,
      def:R`Height above a datum (m), giving the potential-energy term \(gz\). Almost always negligible next to enthalpy changes in gas and vapour systems.`,
      see:[{label:"Kinetic & potential energy",href:"equations.html#eq-ke-pe"}]},
    {id:"g-gravity", term:"Gravitational acceleration", sym:R`g`,
      def:R`9.81 m/s². Appears only in the potential-energy terms.`,
      see:[{label:"Kinetic & potential energy",href:"equations.html#eq-ke-pe"}]},
    {id:"g-area", term:"Area", sym:R`A`,
      def:R`Cross-sectional area normal to the flow (m²), or the surface area across which heat is transferred.`,
      see:[{label:"1-D mass-flow rate",href:"equations.html#eq-mass-flow"}]},
    {id:"g-force", term:"Force", sym:R`F`,
      def:R`Normal force (N). Appears in the definition of pressure and in the \(\int F\,ds\) form of boundary work.`,
      see:[{label:"pdV work",href:"equations.html#eq-pdv-work"}]},
    {id:"g-energy", term:"Stored energy", sym:R`E,\,KE,\,PE`,
      def:R`A system's total stored energy is internal plus kinetic plus potential, \(E = U + KE + PE\). In most closed-system problems the mechanical terms are negligible and only \(\Delta U\) matters.`,
      see:[{label:"Total energy",href:"equations.html#eq-total-energy"}]},
    {id:"g-rate", term:"Rates of heat and work", sym:R`\dot Q,\,\dot W`,
      def:R`Heat transfer rate and power (W) — the per-second forms of \(Q\) and \(W\). A dot always means "per unit time" in this course.`,
      see:[{label:"Rate form of the energy balance",href:"equations.html#eq-energy-rate"}]},
    {id:"g-thermal-efficiency", term:"Thermal efficiency", sym:R`\eta`,
      def:R`Net work out over heat in, for a power cycle. Always less than one — the second law forbids \(\eta = 1\). Distinct from the isentropic efficiencies \(\eta_t\), \(\eta_c\) of individual devices.`,
      see:[{label:"Thermal efficiency",href:"equations.html#eq-thermal-efficiency"}]},
    {id:"g-entropy-production", term:"Entropy production", sym:R`\sigma`,
      def:R`Entropy generated inside the system by irreversibility. Zero for a reversible process, positive for a real one, never negative. <strong>Beware:</strong> \(\sigma\) also denotes the Stefan-Boltzmann constant in the radiation rate law.`,
      see:[{label:"Entropy balance",href:"equations.html#eq-entropy-closed"}]},
    {id:"g-gas-constant", term:"Gas constant", sym:R`R,\,\bar R`,
      def:R`\(R = \bar R/M\), where the universal constant \(\bar R = 8.314\) kJ/kmol·K. For air \(R \approx 0.287\) kJ/kg·K.`,
      see:[{label:"Gas constant",href:"equations.html#eq-gas-constant"}]},
    {id:"g-molar-mass", term:"Molar mass", sym:R`M`,
      def:R`Mass per kmol of substance (kg/kmol); 28.97 for air. Divides the universal gas constant to give the specific one.`,
      see:[{label:"Gas constant",href:"equations.html#eq-gas-constant"}]},
    {id:"g-specific-heat-ratio", term:"Specific-heat ratio", sym:R`k`,
      def:R`\(k = c_p/c_v\); 1.4 for air, and between 1.0 and 1.7 for common gases. Governs the isentropic relations and the Otto and Diesel efficiencies. (Clashes with thermal conductivity \(k\) in the conduction rate law.)`,
      see:[{label:"Specific heats",href:"equations.html#eq-specific-heats"}]},
    {id:"g-polytropic-exponent", term:"Polytropic exponent", sym:R`n`,
      def:R`The exponent in \(pV^n = \text{const}\). \(n=0\) isobaric, \(n=1\) isothermal (ideal gas), \(n=k\) isentropic, \(n\to\infty\) isochoric.`,
      see:[{label:"Polytropic process",href:"glossary.html#g-polytropic"}]},
    {id:"g-heat-transfer-coeffs", term:"Heat-transfer coefficients", sym:R`k,\,h,\,e,\,\sigma`,
      def:R`The constants of the three rate laws: thermal conductivity \(k\) (W/m·K) for conduction, convection coefficient \(h\) (W/m²·K), and emissivity \(e\) with the Stefan-Boltzmann constant \(\sigma = 5.67\times10^{-8}\) W/m²·K⁴ for radiation.`,
      see:[{label:"Heat transfer rate laws",href:"equations.html#eq-heat-modes"}]},
    {id:"g-time", term:"Time", sym:R`t`,
      def:R`The independent variable in every rate form. A quantity with a dot over it is its derivative with respect to \(t\).`,
      see:[{label:"Rate form of the energy balance",href:"equations.html#eq-energy-rate"}]}
  ],
