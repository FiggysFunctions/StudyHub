/* Study Hub service worker
   ...
   visited. Strategy:
     • HTML, subject.js, hub.js, styles.css → network-first (you see edits
       immediately when online, cached copy when offline)
     • fonts / katex / icons → cache-first (these genuinely never change)

   hub.js and styles.css are network-first ON PURPOSE: they are edited as
   often as the content is, and while they were cache-first an edit would
   silently keep serving the old version until the cache version changed
   AND the page was loaded twice. Don't move them back.
...
var PRECACHE = [
  ...
  "mech3780/subject.js",
  "mech3780/week-00.html",
  "mech3780/week-01.html",
  "mech3780/week-02.html",
  "mech3780/week-04.html",
  "mech3780/week-05.html",
  "mech3780/week-07.html"
];
...
function isContent(url) {
  return /\.html$/.test(url.pathname) ||
         ...
         /assets\/hub\.js$/.test(url.pathname) ||
         /assets\/styles\.css$/.test(url.pathname) ||
