...
window.SUBJECT = {
  ...
  equations:[
    ...
    {id:"eq-state-space", cat:"Modelling framework", name:"State-space model",
     ...
     vars:[{sym:R`\mathbf z`,mean:"state vector",href:"glossary.html#g-state"},
           {sym:R`\mathbf u`,mean:"input vector",href:"glossary.html#g-state"},
           {sym:R`\mathbf y`,mean:"output vector",href:"glossary.html#g-state"},
           {sym:R`f,g`,mean:"the vector functions relating them",href:"glossary.html#g-state"},
    ...
    {id:"eq-state-space-linear", cat:"Modelling framework", name:"Linear state-space model",
     ...
     vars:[{sym:R`\mathbf z`,mean:"state vector",href:"glossary.html#g-state"},
           {sym:R`\mathbf u`,mean:"input vector",href:"glossary.html#g-state"},
           {sym:R`\mathbf y`,mean:"output vector",href:"glossary.html#g-state"},
           {sym:R`A`,mean:"system matrix (n×n)",href:"glossary.html#g-state-matrices"},
           {sym:R`B`,mean:"input matrix",href:"glossary.html#g-state-matrices"},
           {sym:R`C`,mean:"output matrix",href:"glossary.html#g-state-matrices"},
           {sym:R`D`,mean:"feedthrough matrix",href:"glossary.html#g-state-matrices"}],
    ...
    {id:"eq-power", cat:"Modelling framework", name:"Power = effort × flow",
     ...
     vars:[{sym:R`P_W`,mean:"power exchanged at the port (W)",href:"glossary.html#g-power-port"},
           {sym:R`e(t)`,mean:"generalised effort (force, torque, voltage, pressure)",href:"glossary.html#g-effort-flow"},
           {sym:R`f(t)`,mean:"generalised flow (velocity, angular velocity, current, flow rate)",href:"glossary.html#g-effort-flow"},
           {sym:R`t`,mean:"time (s)",href:"glossary.html#g-time"}],
    ...
    {id:"eq-energy-vars", cat:"Modelling framework", name:"Energy variables (the states)",
     ...
     vars:[{sym:R`p`,mean:"generalised momentum — the integral of effort",href:"glossary.html#g-energy-variable"},
           {sym:R`q`,mean:"generalised displacement — the integral of flow",href:"glossary.html#g-energy-variable"},
           {sym:R`e`,mean:"generalised effort",href:"glossary.html#g-effort-flow"},
           {sym:R`f`,mean:"generalised flow",href:"glossary.html#g-effort-flow"},
           {sym:R`t`,mean:"time (s)",href:"glossary.html#g-time"}],
    ...
    {id:"eq-state-count", cat:"Modelling framework", name:"How many states?",
     ...
     vars:[{sym:R`N_{states}`,mean:"number of states required",href:"glossary.html#g-state"},
           {sym:R`N_{DOF}`,mean:"degrees of freedom",href:"glossary.html#g-dof"}],
    ...
    {id:"eq-generalised", cat:"Modelling framework", name:"The generalised elements",
     ...
     vars:[{sym:R`e`,mean:"generalised effort",href:"glossary.html#g-effort-flow"},
           {sym:R`f`,mean:"generalised flow",href:"glossary.html#g-effort-flow"},
           {sym:R`q`,mean:"generalised displacement",href:"glossary.html#g-energy-variable"},
           {sym:R`R(\cdot)`,mean:"resistive relation (often linear)",href:"glossary.html#g-generalised-element"},
           {sym:R`\mathcal I(\cdot)`,mean:"inertial relation",href:"glossary.html#g-generalised-element"},
           {sym:R`\mathcal C(\cdot)`,mean:"capacitive relation",href:"glossary.html#g-generalised-element"}],
    ...
    {id:"eq-transformer", cat:"Modelling framework", name:"Ideal transformer & gyrator",
     ...
     vars:[{sym:R`e_1,f_1`,mean:"effort and flow at port 1",href:"glossary.html#g-effort-flow"},
           {sym:R`e_2,f_2`,mean:"effort and flow at port 2",href:"glossary.html#g-effort-flow"}],
    ...
    {id:"eq-newton", cat:"Mechanical systems", name:"Newton's second law",
     ...
     vars:[{sym:R`\sum F_x`,mean:"net force along the direction of motion (N)",href:"glossary.html#g-force"},
           {sym:R`m`,mean:"mass (kg)",href:"glossary.html#g-mass"},
           {sym:R`a_x`,mean:"acceleration (m/s²)",href:"glossary.html#g-acceleration"},
           {sym:R`x`,mean:"position (m); ẍ is its second derivative",href:"glossary.html#g-displacement"},
           {sym:R`t`,mean:"time (s)",href:"glossary.html#g-time"}],
    ...
    {id:"eq-mass-ccr", cat:"Mechanical systems", name:"Point-mass CCRs",
     ...
     vars:[{sym:R`P`,mean:"linear momentum (kg·m/s) — the state",href:"glossary.html#g-momentum"},
           {sym:R`m`,mean:"mass (kg)",href:"glossary.html#g-mass"},
           {sym:R`v`,mean:"velocity (m/s)",href:"glossary.html#g-velocity"},
           {sym:R`F`,mean:"net force (N)",href:"glossary.html#g-force"},
           {sym:R`E_k`,mean:"kinetic energy stored (J)",href:"glossary.html#g-energy"}],
    ...
    {id:"eq-spring-damper", cat:"Mechanical systems", name:"Spring & damper CCRs",
     ...
     vars:[{sym:R`F`,mean:"force (N)",href:"glossary.html#g-force"},
           {sym:R`k`,mean:"stiffness (N/m)",href:"glossary.html#g-stiffness"},
           {sym:R`c`,mean:"compliance, c = 1/k",href:"glossary.html#g-stiffness"},
           {sym:R`\Delta`,mean:"deformation of the spring (m)",href:"glossary.html#g-displacement"},
           {sym:R`b`,mean:"damping coefficient (N·s/m)",href:"glossary.html#g-damping-coefficient"},
           {sym:R`v`,mean:"velocity across the damper (m/s)",href:"glossary.html#g-velocity"},
           {sym:R`E_p`,mean:"potential energy stored (J)",href:"glossary.html#g-energy"}],
    ...
    {id:"eq-rotational-ccr", cat:"Mechanical systems", name:"Rotational CCRs",
     ...
     vars:[{sym:R`L`,mean:"angular momentum (kg·m²/s) — the state",href:"glossary.html#g-angular-momentum"},
           {sym:R`J`,mean:"moment of inertia (kg·m²)",href:"glossary.html#g-moment-inertia"},
           {sym:R`\omega`,mean:"angular velocity (rad/s)",href:"glossary.html#g-angular-velocity"},
           {sym:R`T`,mean:"torque (N·m)",href:"glossary.html#g-torque"},
           {sym:R`k`,mean:"torsional stiffness (N·m/rad)",href:"glossary.html#g-stiffness"},
           {sym:R`\theta`,mean:"angular displacement (rad)",href:"glossary.html#g-angular-displacement"},
           {sym:R`b`,mean:"rotational damping coefficient",href:"glossary.html#g-damping-coefficient"},
           {sym:R`r`,mean:"radius to the mass element",href:"glossary.html#g-moment-inertia"},
           {sym:R`m`,mean:"mass (kg)",href:"glossary.html#g-mass"},
           {sym:R`Q`,mean:"the body being integrated over",href:"glossary.html#g-moment-inertia"}],
     links:[{label:"Week 2",href:"week-02.html"}],
    ...
    {id:"eq-electrical-ccr", cat:"Electrical & electromechanical", name:"Electrical CCRs",
     ...
     vars:[{sym:R`\lambda`,mean:"magnetic linked flux (Wb) — the inductor state",href:"glossary.html#g-linked-flux"},
           {sym:R`L`,mean:"inductance (H)",href:"glossary.html#g-inductance"},
           {sym:R`I`,mean:"current (A)",href:"glossary.html#g-current"},
           {sym:R`V`,mean:"voltage (V)",href:"glossary.html#g-voltage"},
           {sym:R`q`,mean:"charge (C) — the capacitor state",href:"glossary.html#g-charge"},
           {sym:R`C`,mean:"capacitance (F)",href:"glossary.html#g-capacitance"},
           {sym:R`R`,mean:"resistance (Ω)",href:"glossary.html#g-resistance"}],
    ...
    {id:"eq-kirchhoff", cat:"Electrical & electromechanical", name:"Kirchhoff's laws (the SSRs)",
     ...
     vars:[{sym:R`I`,mean:"current into a node (A)",href:"glossary.html#g-current"},
           {sym:R`V`,mean:"voltage change around a loop (V)",href:"glossary.html#g-voltage"}],
    ...
    {id:"eq-dc-motor", cat:"Electrical & electromechanical", name:"Permanent-magnet DC motor",
     ...
     vars:[{sym:R`T`,mean:"torque on the output shaft (N·m)",href:"glossary.html#g-torque"},
           {sym:R`K_T`,mean:"torque constant (N·m/A)",href:"glossary.html#g-motor-constant"},
           {sym:R`I_a`,mean:"armature current (A)",href:"glossary.html#g-current"},
           {sym:R`e`,mean:"back-EMF voltage (V)",href:"glossary.html#g-back-emf"},
           {sym:R`K_\omega`,mean:"back-EMF constant (V·s/rad)",href:"glossary.html#g-motor-constant"},
    ...
    {id:"eq-fluid-inertia", cat:"Fluid power", name:"Fluid inertia",
     ...
     vars:[{sym:R`\mathcal I`,mean:"fluid inertia of the pipe segment",href:"glossary.html#g-pressure-momentum"},
           ...
           {sym:R`\Delta P`,mean:"pressure difference across the pipe (Pa)",href:"glossary.html#g-fluid-pressure"},
           {sym:R`t`,mean:"time (s)",href:"glossary.html#g-time"}],
    ...
    {id:"eq-fluid-cap", cat:"Fluid power", name:"Fluid capacitance & flow",
     ...
     vars:[{sym:R`V`,mean:"stored fluid volume (m³) — the state",href:"glossary.html#g-volume"},
           {sym:R`Q`,mean:"volumetric flow rate (m³/s)",href:"glossary.html#g-flow-rate"},
           {sym:R`P`,mean:"pressure (Pa)",href:"glossary.html#g-fluid-pressure"},
           {sym:R`C`,mean:"fluid capacitance of the tank",href:"glossary.html#g-capacitance"}],
    ...
    {id:"eq-piston", cat:"Fluid power", name:"Piston-cylinder CCRs",
     ...
     vars:[{sym:R`F`,mean:"force on the plunger (N)",href:"glossary.html#g-force"},
           {sym:R`P`,mean:"fluid pressure (Pa)",href:"glossary.html#g-fluid-pressure"},
           {sym:R`P_1,P_2`,mean:"pressures either side of a symmetric plunger",href:"glossary.html#g-fluid-pressure"},
           {sym:R`A_p`,mean:"plunger face area (m²)",href:"glossary.html#g-area"},
           {sym:R`Q`,mean:"volumetric flow rate (m³/s)",href:"glossary.html#g-flow-rate"},
           {sym:R`v`,mean:"plunger velocity (m/s)",href:"glossary.html#g-velocity"}],
    ...
    {id:"eq-equilibrium", cat:"Linearisation & transfer functions", name:"Equilibrium point",
     ...
     vars:[{sym:R`\mathbf z^*`,mean:"equilibrium state",href:"glossary.html#g-equilibrium"},
           {sym:R`\mathbf u^*`,mean:"equilibrium (constant) input",href:"glossary.html#g-equilibrium"},
           {sym:R`f`,mean:"the state-equation function",href:"glossary.html#g-state"}],
    ...
    {id:"eq-taylor", cat:"Linearisation & transfer functions", name:"Taylor linearisation (scalar)",
     ...
     vars:[{sym:R`f`,mean:"the nonlinear function being approximated",href:"glossary.html#g-state"},
           {sym:R`\tilde f`,mean:"its first-order (linear) approximation",href:"glossary.html#g-equilibrium"},
           {sym:R`x`,mean:"the query point",href:"glossary.html#g-equilibrium"},
           {sym:R`x_0`,mean:"expansion (operating) point",href:"glossary.html#g-equilibrium"}],
    ...
    {id:"eq-jacobian", cat:"Linearisation & transfer functions", name:"Jacobian linearisation",
     ...
     vars:[{sym:R`A,B,C,D`,mean:"the four Jacobian matrices of the linear model",href:"glossary.html#g-state-matrices"},
           {sym:R`f,g`,mean:"state-equation and output functions",href:"glossary.html#g-state"},
           {sym:R`\mathbf z,\mathbf u`,mean:"state and input vectors",href:"glossary.html#g-state"},
           {sym:R`*`,mean:"evaluated at the equilibrium",href:"glossary.html#g-equilibrium"}],
     links:[{label:"Week 5",href:"week-05.html"}],
    ...
    {id:"eq-ss-to-tf", cat:"Linearisation & transfer functions", name:"State-space → transfer function",
     ...
     vars:[{sym:R`H(s)`,mean:"transfer function",href:"glossary.html#g-transfer-function"},
           {sym:R`s`,mean:"Laplace variable",href:"glossary.html#g-laplace"},
           {sym:R`I`,mean:"identity matrix",href:"glossary.html#g-state-matrices"},
           {sym:R`A,B,C,D`,mean:"state-space matrices",href:"glossary.html#g-state-matrices"}],
    ...
    {id:"eq-rational-tf", cat:"Linearisation & transfer functions", name:"Rational transfer function",
     ...
     vars:[{sym:R`G(s)`,mean:"transfer function",href:"glossary.html#g-transfer-function"},
           {sym:R`B(s)`,mean:"numerator — its roots are the zeros",href:"glossary.html#g-pole-zero"},
           {sym:R`A(s)`,mean:"denominator — its roots are the poles",href:"glossary.html#g-pole-zero"},
           {sym:R`a_i,b_i`,mean:"polynomial coefficients",href:"glossary.html#g-polynomial-coeffs"},
           {sym:R`n,m`,mean:"denominator and numerator degrees",href:"glossary.html#g-pole-zero"},
           {sym:R`s`,mean:"Laplace variable",href:"glossary.html#g-laplace"}],
    ...
    {id:"eq-closed-loop", cat:"Control fundamentals", name:"Closed-loop transfer function",
     ...
     vars:[{sym:R`Y(s),R(s)`,mean:"output and reference",href:"glossary.html#g-reference"},
           {sym:R`G(s)`,mean:"plant",href:"glossary.html#g-plant"},
           {sym:R`C(s)`,mean:"controller",href:"glossary.html#g-controller"},
           {sym:R`H(s)`,mean:"feedback / sensor path",href:"glossary.html#g-feedback"},
           {sym:R`T(s)`,mean:"closed-loop transfer function",href:"glossary.html#g-transfer-function"},
           {sym:R`s`,mean:"Laplace variable",href:"glossary.html#g-laplace"}],
    ...
    {id:"eq-fvt", cat:"Control fundamentals", name:"Final value theorem",
     ...
     vars:[{sym:R`y_\infty`,mean:"steady-state value of the output",href:"glossary.html#g-dc-gain"},
           {sym:R`y(t),Y(s)`,mean:"output in time and Laplace domains",href:"glossary.html#g-reference"},
           {sym:R`G(0)`,mean:"DC / steady-state gain",href:"glossary.html#g-dc-gain"},
           {sym:R`s`,mean:"Laplace variable",href:"glossary.html#g-laplace"},
           {sym:R`t`,mean:"time (s)",href:"glossary.html#g-time"}],
    ...
    {id:"eq-second-order", cat:"Time-domain response", name:"Second-order standard form",
     ...
     vars:[{sym:R`G(s)`,mean:"transfer function",href:"glossary.html#g-transfer-function"},
           {sym:R`K`,mean:"steady-state gain",href:"glossary.html#g-gain"},
           {sym:R`\omega_n`,mean:"natural frequency (rad/s)",href:"glossary.html#g-natural-frequency"},
           {sym:R`\zeta`,mean:"damping ratio",href:"glossary.html#g-damping-ratio"},
           {sym:R`s`,mean:"Laplace variable",href:"glossary.html#g-laplace"}],
    ...
    {id:"eq-so-poles", cat:"Time-domain response", name:"Second-order poles & damping cases",
     ...
     vars:[{sym:R`p_{1,2}`,mean:"the pole pair",href:"glossary.html#g-pole-zero"},
           {sym:R`\zeta`,mean:"damping ratio",href:"glossary.html#g-damping-ratio"},
           {sym:R`\omega_n`,mean:"natural frequency (rad/s)",href:"glossary.html#g-natural-frequency"},
           {sym:R`\omega_d`,mean:"damped natural frequency (rad/s)",href:"glossary.html#g-natural-frequency"}],
    ...
    {id:"eq-overshoot", cat:"Time-domain response", name:"Percent overshoot",
     ...
     vars:[{sym:R`P.O.`,mean:"percent overshoot",href:"glossary.html#g-overshoot"},
           {sym:R`\zeta`,mean:"damping ratio — the only thing overshoot depends on",href:"glossary.html#g-damping-ratio"}],
    ...
    {id:"eq-settling", cat:"Time-domain response", name:"Rise, settling & peak time",
     ...
     vars:[{sym:R`T_r`,mean:"rise time, 10–90% (s)",href:"glossary.html#g-time-specs"},
           {sym:R`T_s`,mean:"settling time into a 2% band (s)",href:"glossary.html#g-time-specs"},
           {sym:R`T_p`,mean:"peak time (s)",href:"glossary.html#g-time-specs"},
           {sym:R`\zeta`,mean:"damping ratio",href:"glossary.html#g-damping-ratio"},
           {sym:R`\omega_n`,mean:"natural frequency (rad/s)",href:"glossary.html#g-natural-frequency"}],
     links:[{label:"Week 7",href:"week-07.html"}],
    ...
    {id:"eq-bibo", cat:"Stability", name:"BIBO stability",
     ...
     vars:[{sym:R`u(t),y(t)`,mean:"input and output signals",href:"glossary.html#g-reference"},
           {sym:R`K_u,K_y`,mean:"the bounds on input and output",href:"glossary.html#g-bibo"},
           {sym:R`p_i`,mean:"closed-loop poles",href:"glossary.html#g-pole-zero"},
           {sym:R`t`,mean:"time (s)",href:"glossary.html#g-time"}],
    ...
    {id:"eq-char-eq", cat:"Stability", name:"Characteristic equation",
     ...
     vars:[{sym:R`C(s)=P/L`,mean:"controller, as a ratio of polynomials",href:"glossary.html#g-controller"},
           {sym:R`G(s)=B/A`,mean:"plant, as a ratio of polynomials",href:"glossary.html#g-plant"},
           {sym:R`A(s),B(s)`,mean:"plant denominator and numerator",href:"glossary.html#g-pole-zero"},
           {sym:R`L(s),P(s)`,mean:"controller denominator and numerator",href:"glossary.html#g-pole-placement"},
           {sym:R`s`,mean:"Laplace variable",href:"glossary.html#g-laplace"}],
    ...
    {id:"eq-routh", cat:"Stability", name:"Routh–Hurwitz criterion",
     ...
     vars:[{sym:R`a_i`,mean:"characteristic polynomial coefficients",href:"glossary.html#g-polynomial-coeffs"},
           {sym:R`n`,mean:"system order",href:"glossary.html#g-pole-zero"},
           {sym:R`s`,mean:"Laplace variable",href:"glossary.html#g-laplace"}],
    ...
    {id:"eq-ess", cat:"Steady-state error", name:"Steady-state error (unity feedback)",
     ...
     vars:[{sym:R`e_\infty`,mean:"steady-state error",href:"glossary.html#g-error"},
           {sym:R`R(s)`,mean:"reference input",href:"glossary.html#g-reference"},
           {sym:R`T(s)`,mean:"closed-loop transfer function",href:"glossary.html#g-transfer-function"},
           {sym:R`C(s)`,mean:"controller",href:"glossary.html#g-controller"},
           {sym:R`G(s)`,mean:"plant",href:"glossary.html#g-plant"},
           {sym:R`s`,mean:"Laplace variable",href:"glossary.html#g-laplace"}],
    ...
    {id:"eq-error-constants", cat:"Steady-state error", name:"Static error constants",
     ...
     vars:[{sym:R`K_p`,mean:"position constant (step input)",href:"glossary.html#g-system-type"},
           {sym:R`K_v`,mean:"velocity constant (ramp input)",href:"glossary.html#g-system-type"},
           {sym:R`K_a`,mean:"acceleration constant (parabola input)",href:"glossary.html#g-system-type"},
           {sym:R`C(s)`,mean:"controller",href:"glossary.html#g-controller"},
           {sym:R`G(s)`,mean:"plant",href:"glossary.html#g-plant"},
           {sym:R`s`,mean:"Laplace variable",href:"glossary.html#g-laplace"}],
    ...
    {id:"eq-pole-placement", cat:"Steady-state error", name:"Pole placement",
     ...
     vars:[{sym:R`A(s),B(s)`,mean:"plant denominator and numerator",href:"glossary.html#g-pole-zero"},
           {sym:R`L(s),P(s)`,mean:"controller denominator and numerator — the unknowns",href:"glossary.html#g-pole-placement"},
           {sym:R`A_{cl}(s)`,mean:"desired closed-loop polynomial",href:"glossary.html#g-pole-placement"},
           {sym:R`s`,mean:"Laplace variable",href:"glossary.html#g-laplace"}],
    ...
    {id:"eq-pid", cat:"PID & feedback", name:"Ideal PID controller",
     ...
     vars:[{sym:R`u(t)`,mean:"control signal sent to the plant",href:"glossary.html#g-reference"},
           {sym:R`K_P`,mean:"proportional gain",href:"glossary.html#g-pid"},
           {sym:R`K_I`,mean:"integral gain",href:"glossary.html#g-pid"},
           {sym:R`K_D`,mean:"derivative gain",href:"glossary.html#g-pid"},
           {sym:R`e(t)`,mean:"error signal",href:"glossary.html#g-error"},
           {sym:R`C(s)`,mean:"controller transfer function",href:"glossary.html#g-controller"},
           {sym:R`t,\tau`,mean:"time and the integration dummy variable",href:"glossary.html#g-time"},
           {sym:R`s`,mean:"Laplace variable",href:"glossary.html#g-laplace"}],
    ...
    {id:"eq-pid-practical", cat:"PID & feedback", name:"Practical (realisable) PID",
     ...
     vars:[{sym:R`C(s)`,mean:"controller transfer function",href:"glossary.html#g-controller"},
           {sym:R`K_P,K_I,K_D`,mean:"proportional, integral and derivative gains",href:"glossary.html#g-pid"},
           {sym:R`\tau_D`,mean:"derivative filter time constant",href:"glossary.html#g-pid"},
           {sym:R`T_i`,mean:"reset time",href:"glossary.html#g-pid"},
           {sym:R`T_d`,mean:"derivative time",href:"glossary.html#g-pid"},
           {sym:R`s`,mean:"Laplace variable",href:"glossary.html#g-laplace"}],
    ...
    {id:"eq-sensitivity", cat:"PID & feedback", name:"Sensitivity function",
     ...
     vars:[{sym:R`S_G^T`,mean:"sensitivity of T to changes in G",href:"glossary.html#g-sensitivity"},
           {sym:R`S_{ol},S_{cl}`,mean:"open-loop and closed-loop sensitivity",href:"glossary.html#g-sensitivity"},
           {sym:R`T`,mean:"closed-loop transfer function",href:"glossary.html#g-transfer-function"},
           {sym:R`G(s)`,mean:"plant transfer function",href:"glossary.html#g-plant"},
           {sym:R`C(s)`,mean:"controller",href:"glossary.html#g-controller"},
           {sym:R`s`,mean:"Laplace variable",href:"glossary.html#g-laplace"}],
    ...
    {id:"eq-freq-response", cat:"Frequency response", name:"Frequency response",
     ...
     vars:[{sym:R`u(t)`,mean:"sinusoidal input",href:"glossary.html#g-reference"},
           {sym:R`y_{ss}(t)`,mean:"steady-state output — same frequency",href:"glossary.html#g-reference"},
           {sym:R`A`,mean:"input amplitude",href:"glossary.html#g-frequency-response"},
           {sym:R`\omega`,mean:"excitation frequency (rad/s)",href:"glossary.html#g-frequency-response"},
           {sym:R`\phi`,mean:"input phase",href:"glossary.html#g-frequency-response"},
           {sym:R`|G(j\omega)|`,mean:"magnitude response",href:"glossary.html#g-frequency-response"},
           {sym:R`\angle G(j\omega)`,mean:"phase response",href:"glossary.html#g-frequency-response"},
           {sym:R`j`,mean:"imaginary unit",href:"glossary.html#g-imaginary-unit"},
           {sym:R`t`,mean:"time (s)",href:"glossary.html#g-time"}],
    ...
    {id:"eq-decibels", cat:"Frequency response", name:"Magnitude in decibels",
     ...
     vars:[{sym:R`|G(j\omega)|`,mean:"magnitude response",href:"glossary.html#g-frequency-response"},
           {sym:R`dB`,mean:"decibels",href:"glossary.html#g-bode"},
           {sym:R`\omega`,mean:"frequency, on a log axis (rad/s)",href:"glossary.html#g-frequency-response"},
           {sym:R`j`,mean:"imaginary unit",href:"glossary.html#g-imaginary-unit"}],
    ...
    {id:"eq-margins", cat:"Frequency response", name:"Gain margin & phase margin",
     ...
     vars:[{sym:R`\phi_M`,mean:"phase margin (degrees)",href:"glossary.html#g-phase-margin"},
           {sym:R`\omega_{pm}`,mean:"gain-crossover frequency",href:"glossary.html#g-phase-margin"},
           {sym:R`\omega_{gm}`,mean:"phase-crossover frequency",href:"glossary.html#g-gain-margin"},
           {sym:R`C(j\omega)`,mean:"controller frequency response",href:"glossary.html#g-controller"},
           {sym:R`G(j\omega)`,mean:"plant frequency response",href:"glossary.html#g-plant"},
           {sym:R`j`,mean:"imaginary unit",href:"glossary.html#g-imaginary-unit"}],
    ...
    {id:"eq-resonance", cat:"Frequency response", name:"Closed-loop magnitude & resonance",
     ...
     vars:[{sym:R`|T_{cl}(j\omega)|`,mean:"closed-loop magnitude response",href:"glossary.html#g-transfer-function"},
           {sym:R`\omega`,mean:"frequency (rad/s)",href:"glossary.html#g-frequency-response"},
           {sym:R`\omega_n`,mean:"natural frequency (rad/s)",href:"glossary.html#g-natural-frequency"},
           {sym:R`\zeta`,mean:"damping ratio — sets the peak height",href:"glossary.html#g-damping-ratio"},
           {sym:R`j`,mean:"imaginary unit",href:"glossary.html#g-imaginary-unit"}],
  ...
  glossary:[
    ...
    /* ---------------------------------------------------------------
       ...
       This course reuses symbols across domains more than most (the
       Week 3 lecture warns about it explicitly), so where a letter has
       two meanings the entry says so.
       --------------------------------------------------------------- */
    {id:"g-time", term:"Time", sym:R`t`,
      def:R`The independent variable everything is a function of. State-space models are written as first-order ODEs in \(t\); the Laplace transform trades it for \(s\).`,
      see:[{label:"State-space form",href:"equations.html#eq-state-space"}]},
    {id:"g-force", term:"Force", sym:R`F`,
      def:R`The effort variable of the translational mechanical domain (N). Summed via a free-body diagram to give the structural relation for a mass.`,
      see:[{label:"Newton's second law",href:"equations.html#eq-newton"}]},
    {id:"g-mass", term:"Mass", sym:R`m`,
      def:R`The generalised inertia of the translational domain (kg) — it stores kinetic energy and resists acceleration.`,
      see:[{label:"Point-mass CCRs",href:"equations.html#eq-mass-ccr"}]},
    {id:"g-velocity", term:"Velocity", sym:R`v`,
      def:R`The flow variable of the translational domain (m/s) — the time derivative of displacement, and one half of the mechanical power product \(Fv\).`,
      see:[{label:"Effort & flow",href:"glossary.html#g-effort-flow"}]},
    {id:"g-acceleration", term:"Acceleration", sym:R`a`,
      def:R`Rate of change of velocity (m/s²), \(a = \dot v = \ddot x\). Appears only through Newton's second law; the state-space form prefers momentum, whose derivative is force directly.`,
      see:[{label:"Newton's second law",href:"equations.html#eq-newton"}]},
    {id:"g-displacement", term:"Displacement", sym:R`x,\,\Delta`,
      def:R`Position (m), the generalised displacement of the translational domain and therefore a state. \(\Delta\) is used for the deformation of a spring specifically.`,
      see:[{label:"Energy variables",href:"equations.html#eq-energy-vars"}]},
    {id:"g-momentum", term:"Linear momentum", sym:R`P`,
      def:R`\(P = mv\) (kg·m/s) — the generalised momentum of the translational domain, and the state we track. Its derivative is the net force. (Clashes with power and with fluid pressure, both also \(P\).)`,
      see:[{label:"Point-mass CCRs",href:"equations.html#eq-mass-ccr"}]},
    {id:"g-energy", term:"Stored energy", sym:R`E_k,\,E_p`,
      def:R`Kinetic energy \(\tfrac12mv^2\) held by an inertia, and potential energy \(\tfrac12k\Delta^2\) held by a capacitor-like element. Choosing the energy variables as states means the model tracks these directly.`,
      see:[{label:"Energy variable",href:"glossary.html#g-energy-variable"}]},
    {id:"g-stiffness", term:"Stiffness & compliance", sym:R`k,\,c`,
      def:R`A spring's constant of proportionality (N/m), with compliance \(c = 1/k\) its reciprocal. The generalised capacitor of the mechanical domain.`,
      see:[{label:"Spring & damper CCRs",href:"equations.html#eq-spring-damper"}]},
    {id:"g-damping-coefficient", term:"Damping coefficient", sym:R`b`,
      def:R`The constant in a linear damper's law \(F = bv\) (N·s/m) — the generalised resistor of the mechanical domain, dissipating energy as heat.`,
      see:[{label:"Spring & damper CCRs",href:"equations.html#eq-spring-damper"}]},
    {id:"g-angular-momentum", term:"Angular momentum", sym:R`L`,
      def:R`\(L = J\omega\) (kg·m²/s) — the generalised momentum of the rotational domain, and its state. (Clashes with inductance \(L\), which is a real hazard in electromechanical problems.)`,
      see:[{label:"Rotational CCRs",href:"equations.html#eq-rotational-ccr"}]},
    {id:"g-moment-inertia", term:"Moment of inertia", sym:R`J`,
      def:R`\(J = \int r^2\,dm\) (kg·m²) — the rotational equivalent of mass, capturing how far the mass sits from the axis. Because of the \(r^2\), material far out dominates.`,
      see:[{label:"Rotational CCRs",href:"equations.html#eq-rotational-ccr"}]},
    {id:"g-angular-velocity", term:"Angular velocity", sym:R`\omega`,
      def:R`The flow variable of the rotational domain (rad/s). Multiplied by torque it gives power. (Distinct from the frequency \(\omega\) of the control half — same letter, different job.)`,
      see:[{label:"Effort & flow",href:"glossary.html#g-effort-flow"}]},
    {id:"g-torque", term:"Torque", sym:R`T`,
      def:R`The effort variable of the rotational domain (N·m). (Clashes with the time constants \(T_i\), \(T_d\) and the closed-loop transfer function \(T(s)\) later in the course.)`,
      see:[{label:"Rotational CCRs",href:"equations.html#eq-rotational-ccr"}]},
    {id:"g-angular-displacement", term:"Angular displacement", sym:R`\theta`,
      def:R`Angle of rotation (rad) — the generalised displacement of the rotational domain, and therefore a state alongside angular momentum.`,
      see:[{label:"Energy variables",href:"equations.html#eq-energy-vars"}]},
    {id:"g-inductance", term:"Inductance", sym:R`L`,
      def:R`The constant relating linked flux to current, \(\lambda = LI\) (H). The generalised inertia of the electrical domain. (Clashes with angular momentum \(L\).)`,
      see:[{label:"Linked flux",href:"glossary.html#g-linked-flux"}]},
    {id:"g-charge", term:"Electric charge", sym:R`q`,
      def:R`The generalised displacement of the electrical domain (C), stored in capacitors and therefore a state. Current is its derivative, \(I = \dot q\).`,
      see:[{label:"Electrical CCRs",href:"equations.html#eq-electrical-ccr"}]},
    {id:"g-capacitance", term:"Capacitance", sym:R`C`,
      def:R`The constant relating charge to voltage, \(q = CV\) (F). The generalised capacitor of the electrical domain. (Clashes with the controller \(C(s)\) in the control half.)`,
      see:[{label:"Electrical CCRs",href:"equations.html#eq-electrical-ccr"}]},
    {id:"g-resistance", term:"Resistance", sym:R`R`,
      def:R`The constant in Ohm's law \(V = RI\) (Ω) — the generalised resistor of the electrical domain, dissipating energy as heat.`,
      see:[{label:"Electrical CCRs",href:"equations.html#eq-electrical-ccr"}]},
    {id:"g-current", term:"Current", sym:R`I`,
      def:R`The flow variable of the electrical domain (A) — the rate at which charge passes a point. Kirchhoff's current law is the structural relation built on it.`,
      see:[{label:"Kirchhoff's laws",href:"equations.html#eq-kirchhoff"}]},
    {id:"g-voltage", term:"Voltage", sym:R`V`,
      def:R`The effort variable of the electrical domain (V) — potential difference, the driving force for charge migration. (Clashes with volume \(V\) in the fluid domain.)`,
      see:[{label:"Kirchhoff's laws",href:"equations.html#eq-kirchhoff"}]},
    {id:"g-motor-constant", term:"Motor constants", sym:R`K_T,\,K_\omega`,
      def:R`The torque constant (N·m/A) and back-EMF constant (V·s/rad) of a permanent-magnet DC motor. In SI units they have the same magnitude and are often written as one \(K_m\).`,
      see:[{label:"DC motor CCRs",href:"equations.html#eq-dc-motor"}]},
    {id:"g-density", term:"Density", sym:R`\rho`,
      def:R`Mass per unit volume (kg/m³). Appears in the fluid domain, where the mass of fluid in a long pipe gives rise to fluid inertia.`,
      see:[{label:"Fluid inertia",href:"equations.html#eq-fluid-inertia"}]},
    {id:"g-length", term:"Length", sym:R`l`,
      def:R`Pipe length (m). Fluid inertia scales with \(l/A\), so it only matters for long, thin pipes.`,
      see:[{label:"Fluid inertia",href:"equations.html#eq-fluid-inertia"}]},
    {id:"g-area", term:"Area", sym:R`A,\,A_p`,
      def:R`Cross-sectional area (m²); \(A_p\) is a piston's plunger area, which sets the transformer ratio between fluid and mechanical domains. (Clashes with the state matrix \(A\).)`,
      see:[{label:"Piston-cylinder CCRs",href:"equations.html#eq-piston"}]},
    {id:"g-fluid-pressure", term:"Pressure", sym:R`P`,
      def:R`The effort variable of the fluid power domain (Pa). (Clashes with linear momentum and with power, both also \(P\) — read from the domain you are in.)`,
      see:[{label:"Effort & flow",href:"glossary.html#g-effort-flow"}]},
    {id:"g-volume", term:"Volume", sym:R`V`,
      def:R`Stored fluid volume (m³) — the generalised displacement of the fluid domain, and its state. Its derivative is the volumetric flow rate.`,
      see:[{label:"Fluid capacitance",href:"equations.html#eq-fluid-cap"}]},
    {id:"g-flow-rate", term:"Volumetric flow rate", sym:R`Q`,
      def:R`The flow variable of the fluid power domain (m³/s) — the rate at which fluid enters or leaves a volume.`,
      see:[{label:"Fluid capacitance",href:"equations.html#eq-fluid-cap"}]},
    {id:"g-generalised-element", term:"Generalised element", sym:R`R(\cdot),\,\mathcal I(\cdot),\,\mathcal C(\cdot)`,
      def:R`The three archetype constitutive laws: a resistor dissipates (\(e = R(f)\)), an inertia stores via momentum, a capacitor stores via displacement. Every component in every domain is one of these.`,
      see:[{label:"Generalised elements",href:"equations.html#eq-generalised"}]},
    {id:"g-laplace", term:"Laplace variable", sym:R`s`,
      def:R`The complex frequency variable. Transforming an ODE in \(t\) into an algebraic equation in \(s\) is what makes transfer functions possible. Setting \(s = j\omega\) gives the frequency response.`,
      see:[{label:"Transfer function",href:"glossary.html#g-transfer-function"}]},
    {id:"g-imaginary-unit", term:"Imaginary unit", sym:R`j`,
      def:R`\(j = \sqrt{-1}\) (engineers use \(j\) rather than \(i\), which is taken by current). Substituting \(s = j\omega\) evaluates a transfer function along the imaginary axis — the frequency response.`,
      see:[{label:"Frequency response",href:"equations.html#eq-freq-response"}]},
    {id:"g-controller", term:"Controller", sym:R`C(s)`,
      def:R`The transfer function of the compensator you design, sitting in the forward path ahead of the plant. Everything from a plain gain to a PID or a lead-lag network.`,
      see:[{label:"Closed-loop transfer fn",href:"equations.html#eq-closed-loop"}]},
    {id:"g-gain", term:"Gain", sym:R`K`,
      def:R`A constant multiplier. \(K\) in the second-order standard form is the steady-state gain; in a root-locus study it is the parameter being varied.`,
      see:[{label:"DC gain",href:"glossary.html#g-dc-gain"}]},
    {id:"g-state-matrices", term:"State-space matrices", sym:R`A,B,C,D`,
      def:R`The system, input, output and feedthrough matrices of a linear model. Obtained from a nonlinear model as the Jacobians evaluated at an equilibrium; the eigenvalues of \(A\) are the poles.`,
      see:[{label:"Jacobian linearisation",href:"equations.html#eq-jacobian"}]},
    {id:"g-polynomial-coeffs", term:"Polynomial coefficients", sym:R`a_i,\,b_i`,
      def:R`The coefficients of the denominator and numerator of a transfer function. The denominator's coefficients are what the Routh array is built from; matching them is how pole placement is solved.`,
      see:[{label:"Rational transfer function",href:"equations.html#eq-rational-tf"}]},
    {id:"g-error", term:"Error signal", sym:R`e,\,e_\infty`,
      def:R`The difference between reference and output, \(e = r - y\) — what a feedback controller actually acts on. \(e_\infty\) is its steady-state value once transients have decayed.`,
      see:[{label:"Steady-state error",href:"equations.html#eq-ess"}]},
    {id:"g-reference", term:"Reference & output", sym:R`R(s),\,Y(s),\,U(s)`,
      def:R`The command you want followed, the response you get, and the control signal driving the plant — all as Laplace transforms. The closed-loop transfer function is \(Y/R\).`,
      see:[{label:"Closed-loop transfer fn",href:"equations.html#eq-closed-loop"}]},
    {id:"g-overshoot", term:"Percent overshoot", sym:R`P.O.`,
      def:R`How far the step response exceeds its final value, as a percentage. Depends on the damping ratio alone, which is what makes it the usual first step in a design.`,
      see:[{label:"Percent overshoot",href:"equations.html#eq-overshoot"}]},
    {id:"g-time-specs", term:"Time-domain specifications", sym:R`T_r,\,T_s,\,T_p`,
      def:R`Rise time (10–90%), settling time (into a 2% band) and peak time. All three improve with larger \(\omega_n\) once \(\zeta\) has been fixed by the overshoot requirement.`,
      see:[{label:"Rise, settling & peak time",href:"equations.html#eq-settling"}]},
