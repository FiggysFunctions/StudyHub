...
window.SUBJECT = {
  ...
  equations:[
    ...
    {id:"eq-normal-stress", cat:"Stress, strain & elasticity", name:"Normal stress",
     ...
     vars:[{sym:R`\sigma`,mean:"normal stress (Pa)",href:"glossary.html#g-normal-stress"},
           {sym:R`F`,mean:"axial force (N)",href:"glossary.html#g-force"},
           {sym:R`A`,mean:"cross-sectional area",href:"glossary.html#g-area"}],
    ...
    {id:"eq-shear-bearing", cat:"Stress, strain & elasticity", name:"Average shear & bearing stress",
     ...
     vars:[{sym:R`\tau_{\text{avg}}`,mean:"average shear stress (Pa)",href:"glossary.html#g-shear-stress"},
           {sym:R`V`,mean:"transverse (shear) force (N)",href:"glossary.html#g-shear-force"},
           {sym:R`A`,mean:"area resisting shear",href:"glossary.html#g-area"},
           {sym:R`\sigma_b`,mean:"bearing stress (Pa)",href:"glossary.html#g-bearing-stress"},
           {sym:R`P`,mean:"applied load (N)",href:"glossary.html#g-force"},
           {sym:R`A_b = t\,d`,mean:"projected bearing area",href:"glossary.html#g-area"},
           {sym:R`t`,mean:"plate thickness",href:"glossary.html#g-thickness"},
           {sym:R`d`,mean:"pin diameter",href:"glossary.html#g-diameter"}],
    ...
    {id:"eq-oblique", cat:"Stress, strain & elasticity", name:"Stress on an oblique plane",
     ...
     vars:[{sym:R`\sigma_\theta`,mean:"normal stress on the inclined plane (Pa)",href:"glossary.html#g-normal-stress"},
           {sym:R`\tau_\theta`,mean:"shear stress on the inclined plane (Pa)",href:"glossary.html#g-shear-stress"},
           {sym:R`P`,mean:"axial load (N)",href:"glossary.html#g-force"},
           {sym:R`A_0`,mean:"cross-sectional (transverse) area",href:"glossary.html#g-area"},
           {sym:R`\theta`,mean:"angle of the plane normal to the axis",href:"glossary.html#g-angle"}],
    ...
    {id:"eq-normal-strain", cat:"Stress, strain & elasticity", name:"Normal strain",
     ...
     vars:[{sym:R`\varepsilon`,mean:"normal strain (dimensionless)",href:"glossary.html#g-strain"},
           {sym:R`\delta`,mean:"elongation (m)",href:"glossary.html#g-deflection"},
           {sym:R`L`,mean:"original length (m)",href:"glossary.html#g-length"}],
    ...
    {id:"eq-poisson", cat:"Stress, strain & elasticity", name:"Poisson's ratio",
     ...
     vars:[{sym:R`\nu`,mean:"Poisson's ratio",href:"glossary.html#g-poisson"},
           {sym:R`\varepsilon_x`,mean:"axial (longitudinal) strain",href:"glossary.html#g-strain"},
           {sym:R`\varepsilon_y,\varepsilon_z`,mean:"lateral strains",href:"glossary.html#g-strain"}],
    ...
    {id:"eq-hooke-1d", cat:"Stress, strain & elasticity", name:"Hooke's law (1D)",
     ...
     vars:[{sym:R`\sigma`,mean:"normal stress (Pa)",href:"glossary.html#g-normal-stress"},
           {sym:R`E`,mean:"Young's modulus (Pa)",href:"glossary.html#g-young"},
           {sym:R`\varepsilon`,mean:"normal strain",href:"glossary.html#g-strain"}],
    ...
    {id:"eq-axial-deformation", cat:"Stress, strain & elasticity", name:"Axial deformation",
     ...
     vars:[{sym:R`\delta`,mean:"axial deformation (m)",href:"glossary.html#g-deflection"},
           {sym:R`F`,mean:"internal axial force (N)",href:"glossary.html#g-force"},
           {sym:R`E`,mean:"Young's modulus (Pa)",href:"glossary.html#g-young"},
           {sym:R`A`,mean:"cross-sectional area",href:"glossary.html#g-area"},
           {sym:R`L`,mean:"member length (m)",href:"glossary.html#g-length"},
           {sym:R`x`,mean:"position along the member",href:"glossary.html#g-coordinate"}],
    ...
    {id:"eq-thermal", cat:"Stress, strain & elasticity", name:"Thermal deformation",
     ...
     vars:[{sym:R`\delta_T`,mean:"free thermal expansion (m)",href:"glossary.html#g-deflection"},
           {sym:R`\alpha`,mean:"coefficient of thermal expansion (1/°C)",href:"glossary.html#g-thermal"},
           {sym:R`\Delta T`,mean:"temperature change",href:"glossary.html#g-thermal"},
           {sym:R`L`,mean:"member length (m)",href:"glossary.html#g-length"}],
    ...
    {id:"eq-thermal-stress", cat:"Stress, strain & elasticity", name:"Thermal stress (fully restrained)",
     ...
     vars:[{sym:R`R`,mean:"restraining reaction force (N)",href:"glossary.html#g-force"},
           {sym:R`\sigma`,mean:"thermal stress (Pa)",href:"glossary.html#g-normal-stress"},
           {sym:R`A`,mean:"cross-sectional area",href:"glossary.html#g-area"},
           {sym:R`E`,mean:"Young's modulus (Pa)",href:"glossary.html#g-young"},
           {sym:R`\alpha`,mean:"coefficient of thermal expansion (1/°C)",href:"glossary.html#g-thermal"},
           {sym:R`\Delta T`,mean:"temperature change",href:"glossary.html#g-thermal"}],
    ...
    {id:"eq-hooke-3d", cat:"Stress, strain & elasticity", name:"Generalised Hooke's law (3D, isotropic)",
     ...
     vars:[{sym:R`\varepsilon_x,\varepsilon_y,\varepsilon_z`,mean:"normal strains",href:"glossary.html#g-strain"},
           {sym:R`\sigma_x,\sigma_y,\sigma_z`,mean:"normal stresses (Pa)",href:"glossary.html#g-normal-stress"},
           {sym:R`E`,mean:"Young's modulus (Pa)",href:"glossary.html#g-young"},
           {sym:R`\nu`,mean:"Poisson's ratio",href:"glossary.html#g-poisson"},
           {sym:R`\gamma_{xy},\gamma_{xz},\gamma_{yz}`,mean:"engineering shear strains",href:"glossary.html#g-shear-strain"},
           {sym:R`\tau_{xy},\tau_{xz},\tau_{yz}`,mean:"shear stresses (Pa)",href:"glossary.html#g-shear-stress"},
           {sym:R`G`,mean:"shear modulus (Pa)",href:"glossary.html#g-shear-modulus"}],
    ...
    {id:"eq-shear-hooke", cat:"Stress, strain & elasticity", name:"Hooke's law in shear",
     ...
     vars:[{sym:R`\tau`,mean:"shear stress (Pa)",href:"glossary.html#g-shear-stress"},
           {sym:R`G`,mean:"shear modulus (Pa)",href:"glossary.html#g-shear-modulus"},
           {sym:R`\gamma`,mean:"engineering shear strain",href:"glossary.html#g-shear-strain"}],
    ...
    {id:"eq-elastic-constants", cat:"Stress, strain & elasticity", name:"Relation between elastic constants",
     ...
     vars:[{sym:R`E`,mean:"Young's modulus (Pa)",href:"glossary.html#g-young"},
           {sym:R`G`,mean:"shear modulus (Pa)",href:"glossary.html#g-shear-modulus"},
           {sym:R`\nu`,mean:"Poisson's ratio",href:"glossary.html#g-poisson"},
           {sym:R`K`,mean:"bulk modulus (Pa)",href:"glossary.html#g-bulk"}],
    ...
    {id:"eq-strain-notation", cat:"Stress, strain & elasticity", name:"Engineering vs tensor shear strain",
     ...
     vars:[{sym:R`\gamma_{xy}`,mean:"engineering shear strain — the total angle change",href:"glossary.html#g-shear-strain"},
           {sym:R`\varepsilon_{xy}`,mean:"tensor shear strain — half of gamma",href:"glossary.html#g-strain-tensor"},
           {sym:R`\boldsymbol{\varepsilon}`,mean:"the strain tensor",href:"glossary.html#g-strain-tensor"},
           {sym:R`\varepsilon_x,\varepsilon_y,\varepsilon_z`,mean:"normal strains on the diagonal",href:"glossary.html#g-strain"}],
    ...
    {id:"eq-dilation", cat:"Stress, strain & elasticity", name:"Dilation (volumetric strain)",
     ...
     vars:[{sym:R`e`,mean:"dilation — the fractional volume change",href:"glossary.html#g-dilation"},
           {sym:R`\nu`,mean:"Poisson's ratio",href:"glossary.html#g-poisson"},
           {sym:R`E`,mean:"Young's modulus (Pa)",href:"glossary.html#g-young"},
           {sym:R`\sigma_x,\sigma_y,\sigma_z`,mean:"normal stresses (Pa)",href:"glossary.html#g-normal-stress"}], keywords:"volume volumetric bulk hydrostatic"},
    ...
    {id:"eq-bulk", cat:"Stress, strain & elasticity", name:"Bulk modulus",
     ...
     vars:[{sym:R`k`,mean:"bulk modulus (Pa)",href:"glossary.html#g-bulk"},
           {sym:R`E`,mean:"Young's modulus (Pa)",href:"glossary.html#g-young"},
           {sym:R`\nu`,mean:"Poisson's ratio",href:"glossary.html#g-poisson"},
           {sym:R`p`,mean:"hydrostatic pressure (Pa)",href:"glossary.html#g-pressure"},
           {sym:R`e`,mean:"dilation",href:"glossary.html#g-dilation"}],
    ...
    {id:"eq-torsion-strain", cat:"Torsional loading", name:"Shear strain in torsion",
     ...
     vars:[{sym:R`\gamma`,mean:"shear strain at radius r",href:"glossary.html#g-shear-strain"},
           {sym:R`r`,mean:"radius from the shaft axis",href:"glossary.html#g-radius"},
           {sym:R`\phi`,mean:"angle of twist (rad)",href:"glossary.html#g-angle"},
           {sym:R`L`,mean:"shaft length (m)",href:"glossary.html#g-length"}],
    ...
    {id:"eq-torsion-equil", cat:"Torsional loading", name:"Torsion equilibrium",
     ...
     vars:[{sym:R`T`,mean:"internal torque (N·m)",href:"glossary.html#g-torque"},
           {sym:R`r`,mean:"radius from the axis",href:"glossary.html#g-radius"},
           {sym:R`\tau`,mean:"shear stress at that radius (Pa)",href:"glossary.html#g-shear-stress"},
           {sym:R`A`,mean:"cross-sectional area integrated over",href:"glossary.html#g-area"}], links:[{label:"Week 2",href:"week-02.html"}], keywords:"moment integral"},
    ...
    {id:"eq-torsion-stress", cat:"Torsional loading", name:"Torsional shear stress",
     ...
     vars:[{sym:R`\tau`,mean:"torsional shear stress (Pa)",href:"glossary.html#g-shear-stress"},
           {sym:R`T`,mean:"internal torque (N·m)",href:"glossary.html#g-torque"},
           {sym:R`r`,mean:"radius from the axis",href:"glossary.html#g-radius"},
           {sym:R`J`,mean:"polar moment of area",href:"glossary.html#g-polar-moment"},
           {sym:R`A`,mean:"cross-sectional area integrated over",href:"glossary.html#g-area"}],
    ...
    {id:"eq-torsion-angle", cat:"Torsional loading", name:"Angle of twist",
     ...
     vars:[{sym:R`\phi`,mean:"angle of twist (rad)",href:"glossary.html#g-angle-twist"},
           {sym:R`T`,mean:"internal torque (N·m)",href:"glossary.html#g-torque"},
           {sym:R`J`,mean:"polar moment of area",href:"glossary.html#g-polar-moment"},
           {sym:R`G`,mean:"shear modulus (Pa)",href:"glossary.html#g-shear-modulus"},
           {sym:R`L`,mean:"shaft length (m)",href:"glossary.html#g-length"},
           {sym:R`x`,mean:"position along the shaft",href:"glossary.html#g-coordinate"}],
    ...
    {id:"eq-torsion-yield", cat:"Torsional loading", name:"Torque at first yield",
     ...
     vars:[{sym:R`T_y`,mean:"torque at first yield (N·m)",href:"glossary.html#g-torque"},
           {sym:R`J`,mean:"polar moment of area",href:"glossary.html#g-polar-moment"},
           {sym:R`\tau_y`,mean:"yield shear stress (Pa)",href:"glossary.html#g-yield"},
           {sym:R`R`,mean:"outer radius",href:"glossary.html#g-radius"}],
    ...
    {id:"eq-torsion-core", cat:"Torsional loading", name:"Elastic core radius & twist at yield",
     ...
     vars:[{sym:R`\phi_y`,mean:"angle of twist at first yield (rad)",href:"glossary.html#g-angle-twist"},
           {sym:R`\phi`,mean:"current angle of twist (rad)",href:"glossary.html#g-angle-twist"},
           {sym:R`\gamma_y`,mean:"yield shear strain",href:"glossary.html#g-shear-strain"},
           {sym:R`\tau_y`,mean:"yield shear stress (Pa)",href:"glossary.html#g-yield"},
           {sym:R`r_y`,mean:"elastic-core radius",href:"glossary.html#g-radius"},
           {sym:R`R`,mean:"outer radius",href:"glossary.html#g-radius"},
           {sym:R`L`,mean:"shaft length (m)",href:"glossary.html#g-length"},
           {sym:R`G`,mean:"shear modulus (Pa)",href:"glossary.html#g-shear-modulus"}],
     links:[{label:"Week 2",href:"week-02.html"},{label:"Elastoplastic torsion",href:"equations.html#eq-torsion-plastic"}],
    ...
    {id:"eq-torsion-plastic", cat:"Torsional loading", name:"Elastoplastic torsion (cylindrical)",
     ...
     vars:[{sym:R`T`,mean:"applied torque (N·m)",href:"glossary.html#g-torque"},
           {sym:R`T_y`,mean:"torque at first yield (N·m)",href:"glossary.html#g-torque"},
           {sym:R`r_y`,mean:"elastic-core radius",href:"glossary.html#g-radius"},
           {sym:R`R`,mean:"outer radius",href:"glossary.html#g-radius"},
           {sym:R`\phi,\phi_y`,mean:"current and first-yield angle of twist",href:"glossary.html#g-angle-twist"}],
    ...
    {id:"eq-torsion-stress-conc", cat:"Torsional loading", name:"Torsional stress concentration",
     ...
     vars:[{sym:R`\tau_{\max}`,mean:"peak shear stress at the step (Pa)",href:"glossary.html#g-shear-stress"},
           {sym:R`k`,mean:"stress-concentration factor",href:"glossary.html#g-stress-concentration"},
           {sym:R`T`,mean:"internal torque (N·m)",href:"glossary.html#g-torque"},
           {sym:R`d`,mean:"smaller shaft diameter",href:"glossary.html#g-diameter"},
           {sym:R`J`,mean:"polar moment of the smaller section",href:"glossary.html#g-polar-moment"}],
    ...
    {id:"eq-bending-strain", cat:"Bending loads", name:"Bending strain",
     ...
     vars:[{sym:R`\varepsilon`,mean:"bending strain",href:"glossary.html#g-strain"},
           {sym:R`y`,mean:"distance from the neutral axis",href:"glossary.html#g-coordinate"},
           {sym:R`\rho`,mean:"radius of curvature (m)",href:"glossary.html#g-radius-curvature"}],
    ...
    {id:"eq-bending-stress", cat:"Bending loads", name:"Flexure formula",
     ...
     vars:[{sym:R`\sigma_x`,mean:"bending (flexural) stress (Pa)",href:"glossary.html#g-normal-stress"},
           {sym:R`M`,mean:"bending moment (N·m)",href:"glossary.html#g-moment"},
           {sym:R`y`,mean:"distance from the neutral axis",href:"glossary.html#g-coordinate"},
           {sym:R`I`,mean:"second moment of area",href:"glossary.html#g-second-moment"},
           {sym:R`A`,mean:"cross-sectional area integrated over",href:"glossary.html#g-area"}],
    ...
    {id:"eq-parallel-axis", cat:"Bending loads", name:"Parallel-axis theorem",
     ...
     vars:[{sym:R`I`,mean:"second moment about the new axis",href:"glossary.html#g-second-moment"},
           {sym:R`I_0`,mean:"second moment about the piece's own centroid",href:"glossary.html#g-second-moment"},
           {sym:R`A`,mean:"area of the piece",href:"glossary.html#g-area"},
           {sym:R`d`,mean:"distance between the two axes",href:"glossary.html#g-coordinate"}],
    ...
    {id:"eq-beam-deflection", cat:"Bending loads", name:"Elastic beam deflection",
     ...
     vars:[{sym:R`y`,mean:"transverse deflection (m)",href:"glossary.html#g-deflection"},
           {sym:R`x`,mean:"position along the span",href:"glossary.html#g-coordinate"},
           {sym:R`\rho`,mean:"radius of curvature (m)",href:"glossary.html#g-radius-curvature"},
           {sym:R`M`,mean:"bending moment (N·m)",href:"glossary.html#g-moment"},
           {sym:R`EI`,mean:"flexural rigidity",href:"glossary.html#g-flexural-rigidity"}],
    ...
    {id:"eq-yield-moment", cat:"Bending loads", name:"Moment at first yield",
     ...
     vars:[{sym:R`M_y`,mean:"moment at first yield (N·m)",href:"glossary.html#g-moment"},
           {sym:R`\sigma_y`,mean:"yield stress (Pa)",href:"glossary.html#g-yield"},
           {sym:R`I`,mean:"second moment of area",href:"glossary.html#g-second-moment"},
           {sym:R`Y`,mean:"distance to the extreme fibre",href:"glossary.html#g-coordinate"}],
    ...
    {id:"eq-bending-plastic-sym", cat:"Bending loads", name:"Elastoplastic bending (symmetric)",
     ...
     vars:[{sym:R`M`,mean:"moment carried by the part-plastic section",href:"glossary.html#g-moment"},
           {sym:R`\sigma_y`,mean:"yield stress (Pa)",href:"glossary.html#g-yield"},
           {sym:R`I_{\text{elastic}}`,mean:"second moment of the elastic core",href:"glossary.html#g-second-moment"},
           {sym:R`y_y`,mean:"half-depth of the elastic core",href:"glossary.html#g-coordinate"},
           {sym:R`A\bar{y}`,mean:"first moment of each fully plastic zone",href:"glossary.html#g-first-moment"}],
    ...
    {id:"eq-bending-plastic-rect", cat:"Bending loads", name:"Elastoplastic bending (rectangular)",
     ...
     vars:[{sym:R`M`,mean:"moment carried (N·m)",href:"glossary.html#g-moment"},
           {sym:R`M_y`,mean:"moment at first yield (N·m)",href:"glossary.html#g-moment"},
           {sym:R`y_y`,mean:"half-depth of the elastic core",href:"glossary.html#g-coordinate"},
           {sym:R`Y`,mean:"distance to the extreme fibre",href:"glossary.html#g-coordinate"},
           {sym:R`\rho,\rho_y`,mean:"current and first-yield radius of curvature",href:"glossary.html#g-radius-curvature"}],
    ...
    {id:"eq-residual-curvature", cat:"Bending loads", name:"Residual stress & curvature (bending)",
     ...
     vars:[{sym:R`\rho_{\text{resid}}`,mean:"permanent radius of curvature after unloading",href:"glossary.html#g-radius-curvature"},
           {sym:R`\rho_L`,mean:"radius under load",href:"glossary.html#g-radius-curvature"},
           {sym:R`\rho_{UL}`,mean:"radius of the elastic springback",href:"glossary.html#g-radius-curvature"}],
    ...
    {id:"eq-transformed-section", cat:"Bending loads", name:"Composite beam — transformed section",
     ...
     vars:[{sym:R`n`,mean:"modular ratio",href:"glossary.html#g-composite-beam"},
           {sym:R`E_1,E_2`,mean:"moduli of the reference and second material",href:"glossary.html#g-young"},
           {sym:R`\sigma_2`,mean:"true stress in the transformed material (Pa)",href:"glossary.html#g-normal-stress"},
           {sym:R`\sigma_{\text{transf}}`,mean:"stress computed on the transformed section",href:"glossary.html#g-normal-stress"}],
    ...
    {id:"eq-anticlastic", cat:"Bending loads", name:"Anticlastic curvature",
     ...
     vars:[{sym:R`\rho'`,mean:"transverse (anticlastic) radius of curvature",href:"glossary.html#g-anticlastic"},
           {sym:R`\rho`,mean:"radius of curvature of the bending (m)",href:"glossary.html#g-radius-curvature"},
           {sym:R`\nu`,mean:"Poisson's ratio",href:"glossary.html#g-poisson"}],
    ...
    {id:"eq-eccentric-axial", cat:"Bending loads", name:"Eccentric / combined axial loading",
     ...
     vars:[{sym:R`\sigma_x`,mean:"combined stress (Pa)",href:"glossary.html#g-normal-stress"},
           {sym:R`P`,mean:"axial load (N)",href:"glossary.html#g-force"},
           {sym:R`A`,mean:"cross-sectional area",href:"glossary.html#g-area"},
           {sym:R`M`,mean:"moment from the eccentricity (N·m)",href:"glossary.html#g-moment"},
           {sym:R`y`,mean:"distance from the neutral axis",href:"glossary.html#g-coordinate"},
           {sym:R`I`,mean:"second moment of area",href:"glossary.html#g-second-moment"},
           {sym:R`d`,mean:"eccentricity of the load",href:"glossary.html#g-coordinate"}],
    ...
    {id:"eq-shear-horizontal", cat:"Transverse (shear) loading", name:"Shear force on a horizontal plane",
     ...
     vars:[{sym:R`H`,mean:"horizontal shear force on the longitudinal plane (N)",href:"glossary.html#g-shear-flow"},
           {sym:R`V`,mean:"transverse shear force (N)",href:"glossary.html#g-shear-force"},
           {sym:R`Q`,mean:"first moment of the partial area",href:"glossary.html#g-first-moment"},
           {sym:R`I`,mean:"second moment of area",href:"glossary.html#g-second-moment"},
           {sym:R`x`,mean:"length along the beam",href:"glossary.html#g-coordinate"},
           {sym:R`A'`,mean:"partial area above (or below) the cut",href:"glossary.html#g-area"},
           {sym:R`\bar{y}`,mean:"centroid of the partial area from the N.A.",href:"glossary.html#g-coordinate"},
           {sym:R`y`,mean:"distance from the neutral axis",href:"glossary.html#g-coordinate"}],
    ...
    {id:"eq-shear-flow", cat:"Transverse (shear) loading", name:"Shear flow",
     ...
     vars:[{sym:R`q`,mean:"shear flow — force per unit length (N/m)",href:"glossary.html#g-shear-flow"},
           {sym:R`H`,mean:"horizontal shear force (N)",href:"glossary.html#g-shear-flow"},
           {sym:R`x`,mean:"length along the beam",href:"glossary.html#g-coordinate"},
           {sym:R`V`,mean:"transverse shear force (N)",href:"glossary.html#g-shear-force"},
           {sym:R`Q`,mean:"first moment of the partial area",href:"glossary.html#g-first-moment"},
           {sym:R`I`,mean:"second moment of area",href:"glossary.html#g-second-moment"},
           {sym:R`A'`,mean:"partial area above the cut",href:"glossary.html#g-area"},
           {sym:R`\bar{y},y`,mean:"centroid of the partial area, and distance from the N.A.",href:"glossary.html#g-coordinate"}],
    ...
    {id:"eq-fastener-force", cat:"Transverse (shear) loading", name:"Fastener (nail/bolt) force from shear flow",
     ...
     vars:[{sym:R`F`,mean:"force carried by one fastener (N)",href:"glossary.html#g-force"},
           {sym:R`q`,mean:"shear flow (N/m)",href:"glossary.html#g-shear-flow"},
           {sym:R`s`,mean:"longitudinal fastener spacing (m)",href:"glossary.html#g-fastener-spacing"},
           {sym:R`n`,mean:"number of fasteners at each station",href:"glossary.html#g-fastener-spacing"},
           {sym:R`V`,mean:"transverse shear force (N)",href:"glossary.html#g-shear-force"},
           {sym:R`Q`,mean:"first moment of the partial area",href:"glossary.html#g-first-moment"},
           {sym:R`I`,mean:"second moment of area",href:"glossary.html#g-second-moment"}],
    ...
    {id:"eq-shear-stress-transverse", cat:"Transverse (shear) loading", name:"Transverse shear stress",
     ...
     vars:[{sym:R`\tau_{xy},\tau_{yx}`,mean:"transverse shear stress (Pa)",href:"glossary.html#g-shear-stress"},
           {sym:R`\Delta H`,mean:"shear force on the element (N)",href:"glossary.html#g-shear-flow"},
           {sym:R`\Delta A`,mean:"area of the longitudinal face",href:"glossary.html#g-area"},
           {sym:R`V`,mean:"transverse shear force (N)",href:"glossary.html#g-shear-force"},
           {sym:R`Q`,mean:"first moment of the partial area",href:"glossary.html#g-first-moment"},
           {sym:R`I`,mean:"second moment of area",href:"glossary.html#g-second-moment"},
           {sym:R`t`,mean:"width of the section at the cut",href:"glossary.html#g-thickness"}],
    ...
    {id:"eq-shear-rect", cat:"Transverse (shear) loading", name:"Shear stress in a rectangular section",
     ...
     vars:[{sym:R`\tau_{xy}`,mean:"transverse shear stress (Pa)",href:"glossary.html#g-shear-stress"},
           {sym:R`\tau_{\max}`,mean:"peak value, at the neutral axis",href:"glossary.html#g-shear-stress"},
           {sym:R`V`,mean:"transverse shear force (N)",href:"glossary.html#g-shear-force"},
           {sym:R`A`,mean:"cross-sectional area",href:"glossary.html#g-area"},
           {sym:R`y`,mean:"distance from the neutral axis",href:"glossary.html#g-coordinate"},
           {sym:R`Y`,mean:"half-depth of the section",href:"glossary.html#g-coordinate"}],
    ...
    {id:"eq-combined-stress", cat:"Combined (general) loading", name:"Superposition of stresses (combined loading)",
     ...
     vars:[{sym:R`\sigma`,mean:"total normal stress (Pa)",href:"glossary.html#g-normal-stress"},
           {sym:R`\tau`,mean:"total shear stress (Pa)",href:"glossary.html#g-shear-stress"},
           {sym:R`P`,mean:"axial force (N)",href:"glossary.html#g-force"},
           {sym:R`A`,mean:"cross-sectional area",href:"glossary.html#g-area"},
           {sym:R`M`,mean:"bending moment (N·m)",href:"glossary.html#g-moment"},
           {sym:R`y`,mean:"distance from the neutral axis",href:"glossary.html#g-coordinate"},
           {sym:R`I`,mean:"second moment of area",href:"glossary.html#g-second-moment"},
           {sym:R`T`,mean:"torque (N·m)",href:"glossary.html#g-torque"},
           {sym:R`r`,mean:"radius from the axis",href:"glossary.html#g-radius"},
           {sym:R`J`,mean:"polar moment of area",href:"glossary.html#g-polar-moment"},
           {sym:R`V`,mean:"transverse shear force (N)",href:"glossary.html#g-shear-force"},
           {sym:R`Q`,mean:"first moment of the partial area",href:"glossary.html#g-first-moment"},
           {sym:R`t`,mean:"width at the cut",href:"glossary.html#g-thickness"}],
    ...
    {id:"eq-q-circular", cat:"Combined (general) loading", name:"First moment Q — circular sections",
     ...
     vars:[{sym:R`Q_{\text{NA}}`,mean:"first moment of a solid semicircle about the N.A.",href:"glossary.html#g-first-moment"},
           {sym:R`Q_{\text{hollow}}`,mean:"first moment for a hollow circular section",href:"glossary.html#g-first-moment"},
           {sym:R`r`,mean:"radius (m)",href:"glossary.html#g-radius"},
           {sym:R`r_o,r_i`,mean:"outer and inner radii",href:"glossary.html#g-radius"}],
    ...
    {id:"eq-stress-transformation", cat:"Transformation of stress & strain", name:"Stress transformation",
     ...
     vars:[{sym:R`\sigma_{x'},\sigma_{y'}`,mean:"normal stresses on the rotated axes (Pa)",href:"glossary.html#g-normal-stress"},
           {sym:R`\tau_{x'y'}`,mean:"shear stress on the rotated axes (Pa)",href:"glossary.html#g-shear-stress"},
           {sym:R`\sigma_x,\sigma_y`,mean:"normal stresses on the original axes",href:"glossary.html#g-normal-stress"},
           {sym:R`\tau_{xy}`,mean:"shear stress on the original axes",href:"glossary.html#g-shear-stress"},
           {sym:R`\theta`,mean:"rotation angle of the axes",href:"glossary.html#g-angle"}],
    ...
    {id:"eq-mohr-circle", cat:"Transformation of stress & strain", name:"Mohr's circle (plane stress)",
     ...
     vars:[{sym:R`\sigma_{x'}`,mean:"normal stress on the rotated plane (Pa)",href:"glossary.html#g-normal-stress"},
           {sym:R`\tau_{x'y'}`,mean:"shear stress on the rotated plane (Pa)",href:"glossary.html#g-shear-stress"},
           {sym:R`\sigma_{\text{ave}}`,mean:"centre of the circle",href:"glossary.html#g-mohr"},
           {sym:R`R`,mean:"radius of the circle — the max in-plane shear",href:"glossary.html#g-mohr"},
           {sym:R`\sigma_x,\sigma_y`,mean:"normal stresses on the original axes",href:"glossary.html#g-normal-stress"},
           {sym:R`\tau_{xy}`,mean:"shear stress on the original axes",href:"glossary.html#g-shear-stress"}],
    ...
    {id:"eq-traction", cat:"Transformation of stress & strain", name:"Traction & the stress tensor",
     ...
     vars:[{sym:R`\boldsymbol{\sigma}`,mean:"the stress tensor",href:"glossary.html#g-stress-tensor"},
           {sym:R`\tilde{f}`,mean:"force on the element of area",href:"glossary.html#g-force"},
           {sym:R`A`,mean:"area of the plane",href:"glossary.html#g-area"},
           {sym:R`\tilde{n}`,mean:"unit normal to the plane",href:"glossary.html#g-stress-tensor"},
           {sym:R`\tilde{t}`,mean:"unit tangent in the plane",href:"glossary.html#g-stress-tensor"},
           {sym:R`\sigma_{x'x'},\sigma_{y'y'}`,mean:"normal stresses on the rotated axes",href:"glossary.html#g-normal-stress"},
           {sym:R`\tau_{x'y'}`,mean:"shear stress on the rotated axes",href:"glossary.html#g-shear-stress"}],
    ...
    {id:"eq-strain-transformation", cat:"Transformation of stress & strain", name:"Strain transformation",
     ...
     vars:[{sym:R`\varepsilon_{x'},\varepsilon_{y'}`,mean:"normal strains on the rotated axes",href:"glossary.html#g-strain"},
           {sym:R`\gamma_{x'y'}`,mean:"shear strain on the rotated axes",href:"glossary.html#g-shear-strain"},
           {sym:R`\varepsilon_x,\varepsilon_y`,mean:"normal strains on the original axes",href:"glossary.html#g-strain"},
           {sym:R`\gamma_{xy}`,mean:"engineering shear strain on the original axes",href:"glossary.html#g-shear-strain"},
           {sym:R`\theta`,mean:"rotation angle of the axes",href:"glossary.html#g-angle"}],
    ...
    {id:"eq-principal-stress", cat:"Transformation of stress & strain", name:"Principal stresses",
     ...
     vars:[{sym:R`\sigma_{\max,\min}`,mean:"principal stresses (Pa)",href:"glossary.html#g-principal"},
           {sym:R`\sigma_x,\sigma_y`,mean:"normal stresses on the original axes",href:"glossary.html#g-normal-stress"},
           {sym:R`\tau_{xy}`,mean:"shear stress on the original axes",href:"glossary.html#g-shear-stress"},
           {sym:R`\theta_p`,mean:"orientation of the principal planes",href:"glossary.html#g-angle"}],
    ...
    {id:"eq-max-shear-stress", cat:"Transformation of stress & strain", name:"Maximum in-plane shear",
     ...
     vars:[{sym:R`\tau_{\max,\text{in-plane}}`,mean:"maximum in-plane shear stress (Pa)",href:"glossary.html#g-max-shear"},
           {sym:R`R`,mean:"radius of Mohr's circle",href:"glossary.html#g-mohr"},
           {sym:R`\sigma_x,\sigma_y`,mean:"normal stresses on the original axes",href:"glossary.html#g-normal-stress"},
           {sym:R`\tau_{xy}`,mean:"shear stress on the original axes",href:"glossary.html#g-shear-stress"},
           {sym:R`\theta_s`,mean:"orientation of the maximum-shear planes",href:"glossary.html#g-angle"},
           {sym:R`\theta_p`,mean:"orientation of the principal planes",href:"glossary.html#g-angle"}],
    ...
    {id:"eq-max-shear-3d", cat:"Transformation of stress & strain", name:"Maximum shear in 3D (plane stress cases)",
     ...
     vars:[{sym:R`\tau_{\max}`,mean:"absolute maximum shear stress (Pa)",href:"glossary.html#g-max-shear"},
           {sym:R`\sigma_1,\sigma_2,\sigma_3`,mean:"principal stresses, ordered largest to smallest",href:"glossary.html#g-principal"}],
    ...
    {id:"eq-principal-strain", cat:"Transformation of stress & strain", name:"Principal strains",
     ...
     vars:[{sym:R`\varepsilon_{\max,\min}`,mean:"principal strains",href:"glossary.html#g-principal"},
           {sym:R`\varepsilon_x,\varepsilon_y`,mean:"normal strains on the original axes",href:"glossary.html#g-strain"},
           {sym:R`\gamma_{xy}`,mean:"engineering shear strain",href:"glossary.html#g-shear-strain"}],
    ...
    {id:"eq-strain-rosette", cat:"Transformation of stress & strain", name:"Strain rosette",
     ...
     vars:[{sym:R`\varepsilon_i`,mean:"strain measured by gauge i",href:"glossary.html#g-strain-rosette"},
           {sym:R`\theta_i`,mean:"orientation of gauge i",href:"glossary.html#g-strain-rosette"},
           {sym:R`\varepsilon_x,\varepsilon_y`,mean:"the unknown normal strains",href:"glossary.html#g-strain"},
           {sym:R`\gamma_{xy}`,mean:"the unknown shear strain",href:"glossary.html#g-shear-strain"}],
    ...
    {id:"eq-tresca", cat:"Failure criteria", name:"Maximum-shear (Tresca) criterion",
     ...
     vars:[{sym:R`\tau_{\max}`,mean:"maximum shear stress (Pa)",href:"glossary.html#g-max-shear"},
           {sym:R`\sigma_1,\sigma_3`,mean:"largest and smallest principal stresses",href:"glossary.html#g-principal"},
           {sym:R`\sigma_y`,mean:"yield stress in tension (Pa)",href:"glossary.html#g-yield"}],
    ...
    {id:"eq-von-mises", cat:"Failure criteria", name:"Distortion-energy (von Mises) criterion",
     ...
     vars:[{sym:R`\sigma_{vm}`,mean:"von Mises equivalent stress (Pa)",href:"glossary.html#g-vonmises"},
           {sym:R`\sigma_1,\sigma_2,\sigma_3`,mean:"principal stresses (Pa)",href:"glossary.html#g-principal"},
           {sym:R`\sigma_y`,mean:"yield stress in tension (Pa)",href:"glossary.html#g-yield"},
           {sym:R`\sigma_x,\sigma_y`,mean:"in-plane normal stresses (plane-stress form)",href:"glossary.html#g-normal-stress"},
           {sym:R`\tau_{xy}`,mean:"in-plane shear stress",href:"glossary.html#g-shear-stress"}],
    ...
    {id:"eq-distortion-energy", cat:"Failure criteria", name:"Strain energy & distortion energy",
     ...
     vars:[{sym:R`U`,mean:"strain energy",href:"glossary.html#g-strain-energy"},
           {sym:R`v`,mean:"volume",href:"glossary.html#g-strain-energy"},
           {sym:R`U_v,U_d`,mean:"volumetric and distortion parts of the energy",href:"glossary.html#g-distortion-energy"},
           {sym:R`\boldsymbol{\sigma},\boldsymbol{\epsilon}`,mean:"stress and strain tensors",href:"glossary.html#g-stress-tensor"},
           {sym:R`\sigma_{xx},\sigma_{yy},\sigma_{zz}`,mean:"normal stresses",href:"glossary.html#g-normal-stress"},
           {sym:R`\epsilon_{xx},\epsilon_{yy},\epsilon_{zz}`,mean:"normal strains",href:"glossary.html#g-strain"},
           {sym:R`\tau_{xy},\tau_{xz},\tau_{yz}`,mean:"shear stresses",href:"glossary.html#g-shear-stress"},
           {sym:R`\gamma_{xy},\gamma_{xz},\gamma_{yz}`,mean:"shear strains",href:"glossary.html#g-shear-strain"},
           {sym:R`\bar{\sigma},\bar{\epsilon}`,mean:"hydrostatic (mean) stress and strain",href:"glossary.html#g-hydrostatic"},
           {sym:R`\boldsymbol{\sigma}^{*},\boldsymbol{\epsilon}^{*}`,mean:"deviatoric stress and strain",href:"glossary.html#g-hydrostatic"},
           {sym:R`\sigma_1,\sigma_2,\sigma_3`,mean:"principal stresses",href:"glossary.html#g-principal"},
           {sym:R`E`,mean:"Young's modulus (Pa)",href:"glossary.html#g-young"},
           {sym:R`\nu`,mean:"Poisson's ratio",href:"glossary.html#g-poisson"}],
    ...
    {id:"eq-hydrostatic-deviatoric", cat:"Failure criteria", name:"Hydrostatic & deviatoric decomposition",
     ...
     vars:[{sym:R`\bar{\sigma}`,mean:"hydrostatic (mean) stress (Pa)",href:"glossary.html#g-hydrostatic"},
           {sym:R`\bar{\epsilon}`,mean:"mean strain",href:"glossary.html#g-hydrostatic"},
           {sym:R`\sigma_{xx},\sigma_{yy},\sigma_{zz}`,mean:"normal stresses",href:"glossary.html#g-normal-stress"},
           {sym:R`\epsilon_{xx},\epsilon_{yy},\epsilon_{zz}`,mean:"normal strains",href:"glossary.html#g-strain"},
           {sym:R`\boldsymbol{\sigma}`,mean:"the stress tensor",href:"glossary.html#g-stress-tensor"},
           {sym:R`\boldsymbol{\sigma}^{*}`,mean:"the deviatoric part",href:"glossary.html#g-hydrostatic"},
           {sym:R`\mathbf{I}`,mean:"identity tensor",href:"glossary.html#g-hydrostatic"}],
    ...
    {id:"eq-coulomb", cat:"Failure criteria", name:"Coulomb (maximum-normal-stress) criterion — brittle",
     ...
     vars:[{sym:R`\sigma_1,\sigma_2`,mean:"principal stresses (Pa)",href:"glossary.html#g-principal"},
           {sym:R`\sigma_u`,mean:"ultimate strength (Pa)",href:"glossary.html#g-ultimate"}],
    ...
    {id:"eq-mohr-criterion", cat:"Failure criteria", name:"Mohr's criterion — brittle",
     ...
     vars:[{sym:R`\sigma_1,\sigma_2`,mean:"principal stresses (Pa)",href:"glossary.html#g-principal"},
           {sym:R`\sigma_{UT}`,mean:"ultimate strength in tension (Pa)",href:"glossary.html#g-ultimate"},
           {sym:R`\sigma_{UC}`,mean:"ultimate strength in compression (Pa)",href:"glossary.html#g-ultimate"}],
    ...
    {id:"eq-cyl-hoop", cat:"Thin-walled pressure vessels", name:"Cylindrical — hoop stress",
     ...
     vars:[{sym:R`\sigma_h`,mean:"hoop (circumferential) stress (Pa)",href:"glossary.html#g-hoop"},
           {sym:R`P`,mean:"internal gauge pressure (Pa)",href:"glossary.html#g-pressure"},
           {sym:R`R`,mean:"vessel radius (m)",href:"glossary.html#g-radius"},
           {sym:R`t`,mean:"wall thickness (m)",href:"glossary.html#g-thickness"},
           {sym:R`L`,mean:"length of the element considered (m)",href:"glossary.html#g-length"},
           {sym:R`F_x`,mean:"forces summed across the cut",href:"glossary.html#g-force"}],
    ...
    {id:"eq-cyl-axial", cat:"Thin-walled pressure vessels", name:"Cylindrical — axial stress",
     ...
     vars:[{sym:R`\sigma_a`,mean:"axial (longitudinal) stress (Pa)",href:"glossary.html#g-axial-stress"},
           {sym:R`\sigma_h`,mean:"hoop stress (Pa)",href:"glossary.html#g-hoop"},
           {sym:R`P`,mean:"internal gauge pressure (Pa)",href:"glossary.html#g-pressure"},
           {sym:R`R`,mean:"vessel radius (m)",href:"glossary.html#g-radius"},
           {sym:R`t`,mean:"wall thickness (m)",href:"glossary.html#g-thickness"},
           {sym:R`F_z`,mean:"forces summed along the axis",href:"glossary.html#g-force"}],
    ...
    {id:"eq-sphere", cat:"Thin-walled pressure vessels", name:"Spherical vessel stress",
     ...
     vars:[{sym:R`\sigma_h`,mean:"wall stress, equal in every direction (Pa)",href:"glossary.html#g-hoop"},
           {sym:R`P`,mean:"internal gauge pressure (Pa)",href:"glossary.html#g-pressure"},
           {sym:R`R`,mean:"vessel radius (m)",href:"glossary.html#g-radius"},
           {sym:R`t`,mean:"wall thickness (m)",href:"glossary.html#g-thickness"},
           {sym:R`F_z`,mean:"forces summed across the cut",href:"glossary.html#g-force"}],
    ...
    {id:"eq-vessel-max-shear", cat:"Thin-walled pressure vessels", name:"Maximum shear in vessel walls",
     ...
     vars:[{sym:R`\tau_{\max}`,mean:"maximum shear stress in the wall (Pa)",href:"glossary.html#g-max-shear"},
           {sym:R`\sigma_h`,mean:"hoop stress (Pa)",href:"glossary.html#g-hoop"},
           {sym:R`P`,mean:"internal gauge pressure (Pa)",href:"glossary.html#g-pressure"},
           {sym:R`R`,mean:"vessel radius (m)",href:"glossary.html#g-radius"},
           {sym:R`t`,mean:"wall thickness (m)",href:"glossary.html#g-thickness"}],
    ...
    {id:"eq-elastic-curve", cat:"Beam deflection", name:"Elastic curve by double integration",
     ...
     vars:[{sym:R`EI`,mean:"flexural rigidity",href:"glossary.html#g-flexural-rigidity"},
           {sym:R`y`,mean:"deflection of the elastic curve (m)",href:"glossary.html#g-deflection"},
           {sym:R`x`,mean:"position along the span",href:"glossary.html#g-coordinate"},
           {sym:R`M(x)`,mean:"bending moment as a function of x",href:"glossary.html#g-moment"},
           {sym:R`C_1,C_2`,mean:"integration constants from the boundary conditions",href:"glossary.html#g-boundary-conditions"}],
    ...
    {id:"eq-cantilever-results", cat:"Beam deflection", name:"Cantilever tip deflections (standard cases)",
     ...
     vars:[{sym:R`y_{\text{tip}}`,mean:"tip deflection (m)",href:"glossary.html#g-deflection"},
           {sym:R`\theta_{\text{tip}}`,mean:"tip slope (rad)",href:"glossary.html#g-angle"},
           {sym:R`M_0`,mean:"applied end couple (N·m)",href:"glossary.html#g-moment"},
           {sym:R`P`,mean:"applied end load (N)",href:"glossary.html#g-force"},
           {sym:R`w`,mean:"uniformly distributed load (N/m)",href:"glossary.html#g-distributed-load"},
           {sym:R`L`,mean:"cantilever length (m)",href:"glossary.html#g-length"},
           {sym:R`EI`,mean:"flexural rigidity",href:"glossary.html#g-flexural-rigidity"}],
    ...
    {id:"eq-ss-central", cat:"Beam deflection", name:"Simply supported beam — central point load",
     ...
     vars:[{sym:R`EI`,mean:"flexural rigidity",href:"glossary.html#g-flexural-rigidity"},
           {sym:R`y`,mean:"deflection (m)",href:"glossary.html#g-deflection"},
           {sym:R`y_{\max}`,mean:"maximum deflection, at mid-span",href:"glossary.html#g-deflection"},
           {sym:R`P`,mean:"central point load (N)",href:"glossary.html#g-force"},
           {sym:R`L`,mean:"span (m)",href:"glossary.html#g-length"},
           {sym:R`x`,mean:"position along the span",href:"glossary.html#g-coordinate"},
           {sym:R`\theta_A`,mean:"slope at the support (rad)",href:"glossary.html#g-angle"}],
  ...
  glossary:[
    ...
    /* ---------------------------------------------------------------
       ...
       --------------------------------------------------------------- */
    {id:"g-force", term:"Force & load", sym:R`F,\,P,\,R`,
      def:R`An applied or internal force (N). \(P\) is usually the applied load, \(F\) an internal or resultant force, and \(R\) a support reaction. Divided by area it becomes a stress.`,
      see:[{label:"Normal stress",href:"equations.html#eq-normal-stress"}]},
    {id:"g-shear-force", term:"Shear force", sym:R`V`,
      def:R`The transverse internal force on a section (N) — what a pin is "scissored" by, and what drives the transverse shear stress in a beam. Note it is also the letter used for volume elsewhere in engineering.`,
      see:[{label:"Shear flow",href:"equations.html#eq-shear-flow"}]},
    {id:"g-area", term:"Area", sym:R`A,\,A'`,
      def:R`Cross-sectional area (m² or mm²). \(A'\) is the partial area above (or below) the cut used when finding the first moment \(Q\) for shear stress.`,
      see:[{label:"First moment of area",href:"glossary.html#g-first-moment"}]},
    {id:"g-length", term:"Length", sym:R`L`,
      def:R`The length of a member (m) — the span of a beam, the length of a shaft, or the original gauge length a strain is measured against.`,
      see:[{label:"Axial deformation",href:"equations.html#eq-axial-deformation"}]},
    {id:"g-coordinate", term:"Coordinates", sym:R`x,\,y,\,z`,
      def:R`Position within the member. In beams \(x\) runs along the span and \(y\) is measured from the neutral axis — which is why \(y\) appears in the flexure formula and \(x\) in the deflection integrations.`,
      see:[{label:"Flexure formula",href:"equations.html#eq-bending-stress"}]},
    {id:"g-moment", term:"Bending moment", sym:R`M`,
      def:R`The internal couple on a section (N·m), positive when it sags the beam. It is what the flexure formula converts into a linear stress distribution.`,
      see:[{label:"Flexure formula",href:"equations.html#eq-bending-stress"}]},
    {id:"g-torque", term:"Torque", sym:R`T`,
      def:R`The internal twisting moment about a shaft's axis (N·m). The torsional counterpart of the bending moment.`,
      see:[{label:"Torsional shear stress",href:"equations.html#eq-torsion-stress"}]},
    {id:"g-radius", term:"Radius", sym:R`r,\,R`,
      def:R`Distance from an axis (m). In torsion \(r\) is the distance from the shaft centre and \(R\) the outer radius; in pressure vessels \(R\) is the vessel radius. Distinct from the radius of <em>curvature</em> \(\rho\).`,
      see:[{label:"Radius of curvature",href:"glossary.html#g-radius-curvature"}]},
    {id:"g-diameter", term:"Diameter", sym:R`d,\,D`,
      def:R`Pin, bolt or shaft diameter (m). In a stepped shaft \(d\) is the smaller and \(D\) the larger diameter, and their ratio sets the stress-concentration factor.`,
      see:[{label:"Torsional stress concentration",href:"equations.html#eq-torsion-stress-conc"}]},
    {id:"g-thickness", term:"Thickness", sym:R`t`,
      def:R`Wall or plate thickness (m). It is the width of the cut in the transverse-shear formula, the plate thickness in a bearing area, and the wall thickness of a pressure vessel.`,
      see:[{label:"Thin-walled pressure vessel",href:"glossary.html#g-thin-wall"}]},
    {id:"g-deflection", term:"Deflection", sym:R`\delta,\,y`,
      def:R`Displacement under load (m). \(\delta\) is the axial stretch of a bar or the elongation in a compatibility equation; \(y\) is the transverse deflection of a beam's elastic curve.`,
      see:[{label:"Elastic curve",href:"glossary.html#g-elastic-curve"}]},
    {id:"g-angle", term:"Angle", sym:R`\theta,\,\phi`,
      def:R`\(\theta\) is the orientation of a plane in a transformation problem (and the slope of a beam); \(\phi\) is the angle of twist of a shaft. Both in radians unless a degree sign says otherwise.`,
      see:[{label:"Angle of twist",href:"glossary.html#g-angle-twist"}]},
    {id:"g-pressure", term:"Internal pressure", sym:R`P`,
      def:R`The gauge pressure inside a vessel (Pa) — the difference between inside and outside. It is what stretches the wall and produces the hoop and axial stresses.`,
      see:[{label:"Gauge pressure",href:"glossary.html#g-gauge-pressure"}]},
    {id:"g-distributed-load", term:"Distributed load", sym:R`w`,
      def:R`Load spread along a beam, given as force per unit length (N/m). A uniformly distributed load (UDL) is the common case.`,
      see:[{label:"Cantilever tip deflections",href:"equations.html#eq-cantilever-results"}]},
    {id:"g-strain-energy", term:"Strain energy", sym:R`U`,
      def:R`The elastic energy stored per unit volume as a body deforms. Splitting it into a volumetric part and a distortion part is what produces the von Mises criterion.`,
      see:[{label:"Distortion energy",href:"glossary.html#g-distortion-energy"}]},
    {id:"g-fastener-spacing", term:"Fastener spacing & count", sym:R`s,\,n`,
      def:R`\(s\) is the longitudinal spacing between fasteners along a built-up beam and \(n\) the number sharing the load at each station. Together they convert a shear flow into a force per fastener.`,
      see:[{label:"Built-up member",href:"glossary.html#g-built-up"}]}
  ],
